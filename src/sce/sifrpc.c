...

{
  ...
  DAT_0077f538 = 0;
  if (DAT_0077f540 != 0) {
    DAT_0077f538 = *(int *)(param_1 + 0xc);
  }
  piVar13 = (int *)((u32)(&DAT_00969180 + DAT_0077f538 * 0x440) | 0x20000000);
  iVar1 = *piVar13;
  iVar11 = piVar13[1];
