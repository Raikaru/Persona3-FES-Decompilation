...
#pragma alias DAT_0077f560_abs DAT_0077f560
...
#pragma alias DAT_0077fbb8_abs DAT_0077fbb8
extern u8 DAT_0077fbb8_abs[];
...
#pragma alias DAT_00780b48_abs DAT_00780b48
extern u8 DAT_00780b48_abs[];
...
#pragma alias DAT_0096a0e8_abs DAT_0096a0e8
extern u8 DAT_0096a0e8_abs[];
...

{
  ...
  ptr = (u32 *)DAT_0077f560_abs;
  value = 0xffffffff;
  *ptr = value;
  callAddr = (u32)DAT_0096a0e8_abs;
  FUN_00521408(callAddr,0,4);
  return 0;
}
...
#pragma alias RFU086_WaitEvnetFlag_0 RFU086_WaitEvnetFlag
extern u64 RFU086_WaitEvnetFlag_0(void);
#pragma push
#pragma opt_rebuildconditionals off
...
#pragma alias FUN_0050d3a0_u32 FUN_0050d3a0
extern u32 FUN_0050d3a0_u32(void);
#pragma alias FUN_0050d3a0_long FUN_0050d3a0
extern long FUN_0050d3a0_long(void);
#pragma alias FUN_0050d3a0_int FUN_0050d3a0
extern int FUN_0050d3a0_int(void);
...

{
  ...
  *puVar1 = 0;
  base[3] = base[3] + 1;
  puVar2[2] = (base[3] & 0x1ff) << 1 | 1;
  return uVar3 | puVar2[2];
}
// FUN_0050E648 NONMATCHING
u32 FUN_0050e648(void)

{
  u32 uVar2;
  u32 lVar1;
  
  lVar1 = FUN_0050d3a0_u32();
  uVar2 = FUN_0050e5d8();
  if (lVar1 != 0) {
    FUN_0050d3f0();
  }
...
u32 FUN_0050e750(u32 param_1)

{
  u32 uVar1;
  u32 uVar2;
  
  uVar1 = FUN_0050d3a0_u32();
...
u32 FUN_0050e7a0(int *param_1,int *param_2)

{
  u8 *base;
  
  base = DAT_00780b48_abs;
  if (*(int *)(base + 8) < 0) {
    return 0x80008001;
  }
  if (param_1 != 0) {
    *(int *)param_1 = *(int *)(base + 0x10);
  }
  if (param_2 != 0) {
    *(int *)param_2 = 0x80 - *(int *)(base + 0x10);
  }
  return 0;
}
#pragma optimization_level 3
// FUN_0050E7F0 NONMATCHING
u32 FUN_0050e7f0(int *param_1,int *param_2)

{
  long lVar1;
  u32 uVar2;
  
  lVar1 = FUN_0050d3a0_long();
...
u32 FUN_0050e900(u32 param_1)

{
  int lVar1;
  int uVar2;
  
  lVar1 = FUN_0050d3a0_int();
...
#pragma schedule on
// FUN_0050FF38
void FUN_0050ff38(u32 param_1,u32 param_2)
{
