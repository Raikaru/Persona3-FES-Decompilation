...
void opWait0026e000(void)
{
    ...
    {
        void (**setQuadPre)(void* quad, u32 layer, u32 group, u32 pass, u32 blend);
        setQuadPre = (void (**)(void*, u32, u32, u32, u32))D_0096009C;
        (*setQuadPre)(work->quads[0], 4, 0, 1, 2);
        (*setQuadPre)(work->quads[0], 4, 0, 2, 3);
        func_004d7f60(3, 0x717fb);
        func_004d7f60(2, 0x44);
        (*setState)(1, opWaitGetTitleRasterU32(7));
        (*setQuadPre)(work->quads[1], 4, 0, 1, 2);
        (*setQuadPre)(work->quads[1], 4, 0, 2, 3);
        func_004d7f60(3, 0x717fb);
        func_004d7f60(2, 0x44);
        (*setState)(1, opWaitGetTitleRasterU32(8));
        (*setQuadPre)(work->quads[2], 4, 0, 1, 2);
        (*setQuadPre)(work->quads[2], 4, 0, 2, 3);
    }
    func_004d7f60(3, 0x717fb);
    func_004d7f60(2, 0x44);
    for (i = 0; i < 3; i++)
