...
void FUN_00204CC0(void)
{
    ...
    for (i = 0; i < *(u32*)(work + 0x3ac); i++)
    {
        ...
        else if (type == 1 || type == 2)
        {
            ...
            func_003b0d70(handle, 0xf50, i * 0x48);
            func_003b0e20(handle, color);
        }
    }
    for (i = 0; i < *(u32*)(work + 0x3ac); i++)
        ...
        else if (type == 1)
        {
            ...
            *(u32*)(row + 0xc) = *(u32*)(entry + 0x94);
            if (i + *(u32*)(work + 0x76f8) == 0)
                *(u32*)(rowBase + 0x18e0) = *(u32*)(entry + 0x94);
        }
        else
        {
            *(u32*)row = 2;
...
void FUN_002065A0(void)
{
    ...
    K_ASSERT(*(u32*)((u8*)(uintptr_t)(
             ...
             0x105f);
    dispatchRow = (u32*)(work + *(u32*)(work + 0x7700) * 0x18 + 0x2e0);
    type = dispatchRow[1];
    switch (type)
    {
    case 0:
    ...
    case 1:
        ...
        dispatchRow[5] = *(u32*)(work + 0x428);
        dispatchRow[0] |= 1;
        FUN_00208860(*(u16*)((u8*)dispatchRow + 0xc));
        break;
    case 2:
        K_ASSERT(0, 0x108b);
        break;
