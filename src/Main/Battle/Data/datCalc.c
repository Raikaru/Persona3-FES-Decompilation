...
extern u32 FUN_00173460(u16 pcId, s32 skillIdx);
extern u8 FUN_00173510(u16 pcId, u16 statId);
extern u8 FUN_00173510_u16(u16, u32);
extern u8 FUN_001738d0(u16 pcId, u32 statId);
extern u32 FUN_00174960();
extern u32 FUN_00174a90();
extern u32 FUN_001752b0();
extern u32 FUN_00175410();
/* W419 scenario prototype probe: FUN_0017d800(void) changed FUN_00306e80
 * nd2428/object4584 to nd2780/object4584; retained old-style declaration. */
...
u32 FUN_0030b640(s32 param_1,s32 param_2);
...
u8 FUN_00300b60(u16 *param_1,u32 param_2)
{
  ...
  if ((*param_1 & 4) != 0) {
    ...
    base = (u8 *)(((u32)param_2 & 0xffff) + (u32)base);
    bVar2 = *(u8 *)(base + 8);
  }
  else {
    check = uVar1;
    ...
    bVar2 = FUN_00173510_u16(uVar1, param_2);
  }
  if ((s32)bVar2 > 0) {
    goto clamp_bvar2;
  }
...
{
  /* W419 probes: signed uVar3 measured nd437/object716 (baseline nd440); signed
   * uVar3 plus uVar5 also nd437; signed sVar4 nd443/object700. Parameter-width
   * probes p2=u16 nd541/object728, p2=u32 or s32 nd517/object720, p2=s16
   * nd565/object736, p3=s16 nd440, p3=s32 nd441; declaration orders 1-3
   * stayed nd440/object716. All were discarded. */
  u8 bVar1;
  int iVar2;
  u32 uVar3;
  short sVar4;
...

{
  ...
  if (check < 0x11) {
    ...
    if ((uVar2 & 1) != 0) {
      ...
      *(u8 *)(offset + param_1 + 0x1c) = *(u8 *)(offset + param_1 + 0x1c) & 0xf0;
    }
    if (!(check < 0x15)) {
      FUN_0019d3f0((u32)D_0069aa80, 0x455);
    }
    ...
    if ((uVar2 & 1) != 0) {
      ...
      *(u8 *)(offset + param_1 + 0x29) = *(u8 *)(offset + param_1 + 0x29) & 0xf0;
    }
  }
  else {
    uVar2 = check;
...

{
  ...
  if (param_2 != 0) {
    ...
    if ((param_2 & 2) != 0) {
      FUN_00301230(param_1,0,-(char)param_3);
    }
    if ((param_2 & 4) != 0) {
      FUN_00301230(param_1,1,param_3);
    }
    if ((param_2 & 8) != 0) {
      FUN_00301230(param_1,1,-(char)param_3);
    }
    if ((param_2 & 0x10) != 0) {
      FUN_00301230(param_1,2,param_3);
    }
    if ((param_2 & 0x20) != 0) {
      FUN_00301230(param_1,2,-(char)param_3);
    }
    if ((param_2 & 0x40) != 0) {
      FUN_00301230(param_1,3,param_3);
    }
    if ((param_2 & 0x80) != 0) {
      FUN_00301230(param_1,3,-(char)param_3);
    }
    if ((param_2 & 0x100) != 0) {
      FUN_00301230(param_1,4,param_3);
    }
    if ((param_2 & 0x200) != 0) {
      FUN_00301230(param_1,4,-(char)param_3);
    }
    if ((param_2 & 0x400) != 0) {
...

{
  ...
  for (uVar5 = 0; uVar5 < 0x11; uVar5 = uVar5 + 1) {
    ...
    iVar6 = (int)param_1;
    if (uVar4 < 0x11) {
      cVar1 = FUN_00300f60(param_1,(u8)uVar5);
    }
    else {
...

{
  ...
  if (((s32)(param_1 & 0xffff) < 0) || !((s32)(param_1 & 0xffff) < 0x270)) {
  ...
  fVar17 = fVar13;
  fVar12 = fVar13;
   if (((bVar2) || (fVar17 = 1.0f, fVar12 = 1.0f, (int)uVar14 < 1)) || ((param_7 & 1) != 0))
  goto LAB_00305784;
...
LAB_00303918:
  ...
  case 2:
    ...
    fVar18 = fVar18 * ((float)*(u16 *)(iGpffffb7a4 + (uVar6 & 0xff) * 2) / 100.0f);
    break;
  case 3:
    uVar6 = FUN_00181b10();
    if (0x1d < (uVar6 & 0xff)) {
    ...
    fVar18 = fVar18 * ((float)*(u16 *)(iGpffffb7a8 + (uVar6 & 0xff) * 2) / 100.0f);
    break;
  case 4:
    if ((*puVar10 & 4) == 0) {
      sVar5 = FUN_0016c920(puVar10[1]);
...

{
  ...
  if ((uVar9 == 0) ||
     ((cVar2 = *(char *)(DAT_007ce3f8 + 0x18 + iVar11), cVar2 != '\x01' &&
      (fVar13 = 1.0f, cVar2 != '\x03')))) goto LAB_00305f20;
  puVar10 = (u16 *)param_3;
...
{
  /* W419 probe negative: adding explicit case 7: break to the initial switch
   * left nd2782/object4584 unchanged; the omitted case remains intentional. */
  s32 bVar1;
  u16 uVar2;
  u32 uVar3;
  u32 uVar7;
...
LAB_00306f0c:
  ...
  if ((*puVar11 & 4) == 0) {
    ...
    if ((uVar7 & 0xffff) == 0) {
      ...
      else if ((uVar9 & 0x27000000) != 0) {
        uVar7 = uVar7 | 100;
      }
      else if ((uVar9 & 0x10000000) != 0) {
        uVar7 = uVar7 | 0x32;
      }
    }
  }
...
{
  /* W419 probes: local declaration permutations stayed nd301/object660; param_2
   * u32 or s32 widened to object652 and worsened nd469. Retained u16/order. */
  u8 cVar1;
  u32 uVar2;
  s32 lVar3;
  int iVar4;
                          ...
                          u16 param_4, u32 param_5)
{
  ...
  blocked = (*(u32 *)(param_2 + 6) & 0x100000) != 0;
  if (blocked) {
    result = false;
    goto done;
  }
  ...
  entryOffset = (u32)param_3 * 0x2c;
  entry = (u8 *)iGpffffb708 + entryOffset;
  if ((entry[0x11] == 0) &&
      ((entry[0x18] != 1 || ((*(u32 *)(entry + 0x1c) & 0x80000) == 0)))) {
    result = false;
    goto done;
  }
  uVar4 = (u32)param_3;
  if (((param_1 != 0) && (param_3 < 0x1d0)) &&
    ...
    uVar4 = (u32)*(u16 *)((u32)puVar5[1] * 0x3e +
                           iGpffffb720 + 0x3c);
  }
...
have_type:
  ...
  result = (1 << ((int)sVar2 + 1U & 0x1f) & 0xe0001U) != 0;
done:
  return result;
}
...
void FUN_0030c520(void)
{
  ...
  if (FUN_00311250() != 0) {
    if (FUN_003111f0() != 0) {
      value = (float)FUN_0030fdf0(0xe, 2) + (float)FUN_0030fdf0(0xe, 2);
      value = (((float)FUN_0030fdf0(0x13, 0) - 30.0f) * 30.0f) / (value * 5.0f);
      value *= (float)FUN_0030fdf0(0xd, 0) / 5.0f;
      value = sqrtf(value) * 10.0f;
      value *= (float)FUN_0030fdf0(0xc, 0);
      value *= (float)FUN_0030fdf0(0x17, 0);
    } else {
      value = (float)FUN_0030fdf0(0x20, 0) / 2.0f;
      value = DAT_007cad74 *
              ((float)FUN_0030fdf0(0xe, 2) * 2.0f + value / 2.0f);
      value = ((float)FUN_0030fdf0(0x13, 0) * 30.0f) / (value * 5.0f);
      value *= (float)FUN_0030fdf0(0xd, 0) / 5.0f;
      value = sqrtf(value) * 10.0f;
      value *= (float)FUN_0030fdf0(0xc, 0);
      product = value * (float)FUN_0030fdf0(0x17, 0);
      value = DAT_007caf8c * product;
    }
  } else {
    if (FUN_003111f0() != 0) {
      value = (float)FUN_0030fdf0(0xe, 2) + (float)FUN_0030fdf0(0xe, 2);
...
void FUN_0030c930(void)
{
  ...
  if (FUN_003111f0() != 0) {
    value = (float)FUN_0030fdf0(0xe, 2);
    value += (float)FUN_0030fdf0(0xe, 2);
    value = ((float)FUN_0030fdf0(0x13, 0) * 30.0f) / (value * 5.0f);
    value *= (float)FUN_0030fdf0(0xd, 1) / 5.0f;
    result = sqrtf(value) * 10.0f;
    result *= (float)FUN_0030fdf0(0xc, 0);
    factor = (float)FUN_0030fdf0(0x17, 0);
    factor = result * factor + (float)FUN_0030fdf0(0x19, 0);
  } else {
    value = (float)FUN_0030fdf0(0x20, 0) / 2.0f;
    value = DAT_007cad74 *
            ((float)FUN_0030fdf0(0xe, 2) * 2.0f + value / 2.0f);
    ...
    factor *= DAT_007caf8c;
    factor -= 10.0f;
    factor *= (float)FUN_0030fdf0(0xc, 0);
  }
  FUN_00311190((int)factor);
}
...
void FUN_0030cc40(void)
{
  ...
  if (FUN_003111f0() != 0) {
    value = (float)FUN_0030fdf0(0xd, 3) + 200.0f;
    value /= (float)FUN_0030fdf0(0xe, 3) + 200.0f;
    output = value * (float)FUN_0030fdf0(0x11, 0);
  } else {
    value = (float)FUN_0030fdf0(0xd, 3) + 200.0f;
    ratio = value / ((float)FUN_0030fdf0(0xe, 3) + 200.0f);
    value = (float)FUN_0030fdf0(0xd, 3) + 200.0f;
    value /= (float)FUN_0030fdf0(0x1f, 0) / 2.0f + 200.0f;
    output = ratio * value * (float)FUN_0030fdf0(0x11, 0);
  }
  FUN_00311190((int)output);
}
...
void FUN_0030d4e0(void)
{
  ...
  value = (float)FUN_0030fdf0(0xe, 2);
  value += (float)FUN_0030fdf0(0xe, 2);
  value = ((float)FUN_0030fdf0(0x13, 0) - 30.0f) * 30.0f /
          (value * 5.0f);
  value *= (float)FUN_0030fdf0(0xd, 0) / 5.0f;
  value = sqrtf(value) * 10.0f;
  value *= (float)FUN_0030fdf0(0xc, 0);
  value *= (float)FUN_0030fdf0(0x17, 0);
  value *= (float)FUN_0030fdf0(0x1b, 0);
  value *= (float)FUN_0030fdf0(0x21, 0);
  FUN_00311190((int)(value * DAT_007cad74));
}
...
void FUN_0030ddf0(void)
{
  ...
  if (FUN_003111f0() != 0) {
    value = (float)FUN_0030fdf0(0x13, 0);
    factor = value + (float)FUN_0030fdf0(0x1a, 0);
    value = 1.5f * factor;
  } else {
    value = (float)FUN_0030fdf0(0x1a, 0);
    factor = 0.5f;
    value = factor * value + (float)FUN_0030fdf0(0x13, 0);
  }
  FUN_00311190((int)value);
}
...
void FUN_0030f120(void)
{
  ...
  if (lVar1 != 0) {
    ...
    fVar3 = fVar3 + fVar2;
    fVar2 = fVar5 / fVar3;
    fVar4 = (float)FUN_0030fdf0(0xd,3);
    fVar3 = 200.0f;
    fVar5 = fVar3 + fVar4;
