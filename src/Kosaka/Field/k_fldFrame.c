                    ...
                    const void* triangle, FldFrameRaycast* raycast)
{
    ...
    candidate = (const FldFrameCollisionTriangle*)triangle;
    const RwV3d normal = candidate->normal;
    ...
    denominator = normal.y * segment.y;
    denominator += normal.x * segment.x;
    denominator += normal.z * segment.z;
    vertexDot = normal.z * candidate->vertices[0]->z;
    vertexDot += normal.x * candidate->vertices[0]->x;
    vertexDot += normal.y * candidate->vertices[0]->y;
    lineDot = normal.z * lineCopy.point[0].z;
    lineDot += normal.x * lineCopy.point[0].x;
    lineDot += normal.y * lineCopy.point[0].y;
