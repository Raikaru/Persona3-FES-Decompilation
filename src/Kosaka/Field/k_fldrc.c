...
void FUN_001b5200(u32* resource, f32 angle)
{
    ...
    colorPtr = color;
    *(u64*)colorPtr = DAT_00678f68_abs[0];
    colorPtr[2] = DAT_00678f70_abs[0];
    if ((*resource & 1) == 0)
    {
        if (resource[2] != 0)
        {
    ...
    for (i = 0; i < resource[5]; i++)
    {
        if (resource[i + 6] != 0)
        {
            FUN_004cb890_typed(*(u32*)(resource[i + 6] + 4), colorPtr, angle, 2);
        }
    }
    for (i = 0; i < resource[0x46]; i++)
    {
        ...
        if ((type == 0) || (type == 2))
        {
            FUN_00318a50_typed(resource[i * 6 + 0x4a], angle, colorPtr, 2);
        }
        else if (type == 1)
        {
