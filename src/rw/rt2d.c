...
u64 FUN_004b8290(u64 param_1,u32 *param_2);
...
extern void FUN_004b1a30(u32 *param_1);
extern u32 FUN_004b1a40(u32 *param_1);
extern u32 FUN_004b1a60(int param_1);
extern u32 FUN_004b1a70(int param_1);
extern int FUN_004b1a80(u32 *param_1);
extern u32 FUN_004b1ae0(int param_1);
extern u32 FUN_004b1b60(int param_1);
...
extern u64 FUN_004b2ad0(u64 param_1,u32 param_2);
...
extern u64 FUN_004b30a0(u64 param_1);
extern u64 FUN_004b3100(u64 param_1);
...
{
  FUN_004c3c30(DAT_0095ed94);
  FUN_004c3c30(DAT_0095ed98);
  DAT_0095ed94 = 0;
  DAT_0095ed98 = 0;
  return;
}
...
// FUN_004B1100 NONMATCHING
u32 FUN_004b1100(void)

{
  DAT_0095f034 = 0;
  DAT_0095f038 = 0;
  DAT_0095f03c = FUN_0046a890(0x1001a);
  DAT_0095f040 = FUN_0046a890(0x1001a);
  DAT_0095f04c = FUN_0046a890(0x1001e);
  DAT_0095f050 = FUN_0046a890(0x1001e);
  DAT_0095f044 = FUN_0046a890(0x1001c);
  DAT_0095f048 = FUN_0046a890(0x1001c);
  return 1;
}
// FUN_004B11A0 NONMATCHING
...
// FUN_004B1A30 NONMATCHING
void FUN_004b1a30(u32 *param_1)

{
  FUN_004c2120(*param_1);
  return;
}
// FUN_004B1A40 NONMATCHING
...
// FUN_004B1A60 NONMATCHING
u32 FUN_004b1a60(int param_1)

{
  return *(u32 *)(param_1 + 8);
}
// FUN_004B1A70 NONMATCHING
u32 FUN_004b1a70(int param_1)
...
u32 FUN_004b1ae0(int param_1)

{
  u32 uVar1;
  
  if (*(u32 **)(param_1 + 0x10) == (u32 *)0x0) {
    uVar1 = 0;
  }
  else {
...
u32 FUN_004b1b60(int param_1)

{
  u32 uVar1;
  
  if (*(u32 **)(param_1 + 0x14) == (u32 *)0x0) {
...
u64 FUN_004b2e20(u64 param_1)

{
  u32 uVar1;
  
  uVar1 = FUN_004c1d50(0x10,0x301a9);
  *(u32 *)((int)param_1 + 0xc) = uVar1;
...
u64 FUN_004b3490(u64 param_1)

{
  if (*(int *)((int)param_1 + 0x10) != 0) {
    FUN_004c20b0();
    *(u32 *)((int)param_1 + 0x10) = 0;
  }
  return param_1;
}
// FUN_004B34D0 NONMATCHING
void FUN_004b34d0(int param_1)

{
  FUN_004c21b0(*(u32 *)(param_1 + 0x10));
  return;
}
...
// FUN_004B4A60 NONMATCHING
void FUN_004b4a60(int param_1)

{
  FUN_004c21b0(*(u32 *)(param_1 + 8));
  return;
}
  ...
  for (puVar3 = (u32 *)FUN_004c2090(*(u32 *)(iVar8 + 8)); puVar3 != puVar2;
    ...
    if ((*puVar3 & 1) == 0) {
      if (puVar3[6] != 0) {
        ...
        fVar13 = (int)((float)FUN_004b1a60((int)(puVar3 + 1)));
...
u64 FUN_004b5330(u64 param_1)

{
  long lVar1;
  
  if ((*(int *)((int)param_1 + 0x24) != 0) && (lVar1 = FUN_004ae940(), lVar1 == 0)) {
    param_1 = 0;
  }
  return param_1;
}
...

{
  ...
  uVar1 = *(u32 *)((int)param_1 + 4);
  if ((uVar1 & 1) != 0) {
    *(u32 *)((int)param_1 + 4) = uVar1 & 0xfffffffe;
  }
  return param_1;
}
...

{
  ...
  lVar1 = FUN_004ca520(0,0x1b7,0x4b65a0,0x4b6600);
  return 0 < lVar1;
}
...

{
  ...
  puVar4 = puVar1;
  while (puVar2 != puVar1) {
    puVar4 = (u32 *)((int)puVar4 + *(int *)(*param_1 + 8));
    iVar3 = iVar3 + 1;
    puVar2 = (u32 *)*puVar4;
  }
  return iVar3;
...

{
  ...
  puVar1 = (u32 *)(*DAT_00960178)(param_1 * param_2 + 0x4c,0x3001b);
  puVar1[0xb] = param_1;
  *puVar1 = 0;
  puVar1[2] = 0;
  puVar1[1] = 0;
...
// FUN_004B6EB0 NONMATCHING
void FUN_004b6eb0(void)

{
                    /* WARNING: Could not recover jumptable at 0x004b6eb8. Too many branches */
...
{
  FUN_00521250(param_1 + 0x4c,param_2 + 0x4c,*(int *)(param_1 + 0x24) * *(int *)(param_1 + 0x2c));
  return 1;
}
...
// FUN_004B7750 NONMATCHING
u32 FUN_004b7750(int param_1)

{
  return *(u32 *)(param_1 + 0x14);
}
// FUN_004B7760 NONMATCHING
u64 FUN_004b7760(u64 param_1,u32 param_2)
...

{
  ...
  iVar1 = ((code)FUN_004b91b0)(*(u32 *)(param_1 + 0x14));
...
// FUN_004B97B0 NONMATCHING
u32 FUN_004b97b0(int param_1,int param_2)

{
  return *(u32 *)(param_2 * 4 + param_1 + iGpffffbbc4 + 8);
}
// FUN_004B97D0 NONMATCHING
u64 FUN_004b97d0(u64 param_1,u32 param_2,int param_3)

{
  *(u32 *)(param_3 * 4 + (int)param_1 + iGpffffbbc4 + 8) = param_2;
  return param_1;
}
...
// FUN_004BCAE0 NONMATCHING
u64 FUN_004bcae0(u64 param_1,int param_2)

{
  *(u8 **)(param_2 + 0x18) = &LAB_004bcb20;
  FUN_004bca00(0,0);
  return param_1;
}
