...
void h_campDrawStatusOverview(int param_1)
{
    ...
    sp98.u = *(u64*)&pair;
    sp98.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0)), 0, 2, 2, sp98.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = 13.0f;
    pair.y = 27.0f;
    sp40.u = *(u64*)&pair;
    sp40.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x44), 0, 2, 2, sp40.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = 112.0f;
    pair.y = 27.0f;
    sp48.u = *(u64*)&pair;
    sp48.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x88), 0, 2, 2, sp48.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = 135.0f;
    pair.y = 27.0f;
    sp50.u = *(u64*)&pair;
    sp50.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0xcc), 0, 2, 2, sp50.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = 278.0f;
    pair.y = 27.0f;
    sp58.u = *(u64*)&pair;
    sp58.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x110), 0, 2, 2, sp58.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = (f32)0x12d;
    pair.y = 27.0f;
    sp60.u = *(u64*)&pair;
    sp60.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x154), 0, 2, 2, sp60.u, *(u64*)&pair, 0, 0, 0, 10);
    for (i = 0; i < 4; i++) {
        if (*(s32*)(param_1 + 0x1c) - 1 < i)
            *(u32*)(*(u32*)(param_1 + 0xc0) + i * 0x44 + 0x2ac) = 0;
            ...
            sp68.u = *(u64*)&pair;
            sp68.f[0] += 0.0f;
            func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + (i + 10) * 0x44), 0, 2, 2, sp68.u, *(u64*)&pair, 0, 0, 0, 10);
        }
    }
    pair.x = 104.0f;
    pair.y = 61.0f;
    sp70.u = *(u64*)&pair;
    sp70.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x550), 0, 2, 2, sp70.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = 124.0f;
    pair.y = 219.0f;
    sp78.u = *(u64*)&pair;
    sp78.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x594), 0, 2, 2, sp78.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = 226.0f;
    pair.y = (f32)0x19f;
    sp80.u = *(u64*)&pair;
    sp80.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x83c), 0, 2, 2, sp80.u, *(u64*)&pair, 0, 0, 0, 10);
    pair.x = (f32)0x1b7;
    pair.y = (f32)0x19f;
    sp88.u = *(u64*)&pair;
    sp88.f[0] += 0.0f;
    func_0018bc10(100.0f, (void*)(*(u32*)(param_1 + 0xc0) + 0x880), 0, 2, 2, sp88.u, *(u64*)&pair, 0, 0, 0, 10);
}
...

{
    ...
    campDrawTransition(100.0f, (void*)(*(u32*)(param_1 + 0xc0)), 0, 2, 2, start.u, *(u64*)&pair, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x44), 0, 2, 2, 0x41d8000041500000, 0x41d80000c2ae0000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x88), 0, 2, 2, 0x41d8000042e00000, 0x41d8000041400000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0xcc), 0, 2, 2, 0x41d8000043070000, 0x41d80000420c0000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x110), 0, 2, 2, 0x41d80000438b0000, 0x41d8000043320000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x154), 0, 2, 2, 0x41d8000043968000, 0x41d8000043490000, 0, 0, 0, 0);
  for (iVar1 = 0; iVar1 < 4; iVar1 = iVar1 + 1) {
    if (*(int *)(param_1 + 0x1c) + -1 < iVar1) {
      *(u32 *)(*(int *)(param_1 + 0xc0) + iVar1 * 0x44 + 0x2ac) = 0;
      ...
      func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + (iVar1 + 10) * 0x44), 0, 2, 2, CAMP_PAIR_FLOAT_HIGH(fVar2,0x41f00000), CAMP_PAIR_FLOAT_HIGH(fVar2,0xc28c0000), 0, 0, 0, 0);
    }
  }
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x550), 0, 2, 2, 0x4274000042d00000, 0x4274000040800000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x594), 0, 2, 2, 0x435b000042f80000, 0x435b000041c00000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x83c), 0, 2, 2, 0x43cf800043620000, 0x43cf800042fc0000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc0) + 0x880), 0, 2, 2, 0x43cf800043db8000, 0x43cf800043a98000, 0, 0, 0, 0);
...

{
  ...
  func_0018bc10(100.0f, (void*)(*(u32 *)(param_1 + 0xc4)), 0, 2, 2, 0x4140000043be8000, 0x4140000043be8000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x44), 0, 2, 2, 0x41d8000041500000, 0x41d8000041500000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x88), 0, 2, 2, 0x41d8000042e00000, 0x41d8000042e00000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0xcc), 0, 2, 2, 0x41d8000043070000, 0x41d8000043070000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x110), 0, 2, 2, 0x41d8000043888000, 0x41d8000043888000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x154), 0, 2, 2, 0x41d8000043968000, 0x41d8000043968000, 0, 0, 0, 0);
  for (iVar1 = 0; iVar1 < 4; iVar1 = iVar1 + 1) {
    if (*(int *)(param_1 + 0x1c) + -1 < iVar1) {
      *(u32 *)(*(int *)(param_1 + 0xc4) + iVar1 * 0x44 + 0x2ac) = 0;
    }
      ...
      func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + (iVar1 + 10) * 0x44), 0, 2, 2, uStack_38, CAMP_PAIR_FLOAT_HIGH(fVar2,0x44188000), 0, 0, 0, 0);
    }
  }
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x550), 0, 2, 2, 0x42740000423c0000, 0x42740000423c0000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x594), 0, 2, 2, 0x435b000042860000, 0x435b000042860000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x7f8), 0, 2, 2, 0x43cf800043620000, 0x43cf800043620000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc4) + 0x83c), 0, 2, 2, 0x43cf8000440c4000, 0x43cf8000440c4000, 0, 0, 0, 0);
  return;
}
...

{
  ...
  func_0018bc10(100.0f, (void*)(*(u32 *)(param_1 + 0xc)), 0, 2, 1, 0xc1600000423c0000, 0xc1600000423c0000, 0, 0, 0, 0);
  fVar1 = (float)(*(int *)(param_1 + 4) * 0x21) + 124.0f;
  uStack_10 = CAMP_PAIR_FLOAT_HIGH(fVar1 - 300.0f,0x44138000);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x88), 0, 2, 1, uStack_10, CAMP_PAIR_FLOAT_HIGH(fVar1,0x44138000), 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x44), 0, 2, 1, 0xc3ed800043c50000, 0x42fa000043c50000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0xcc), 0, 2, 1, 0x42fc0000442f8000, 0x42fc000043c90000, 0, 0, 0, 0);
  *(u32 *)(*(int *)(param_1 + 0xc) + 0x150) = 0;
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x110), 0, 2, 0, 0xc38e800043a08000, 0x4170000043a08000, 0, 0, 0, 0);
  *(u32 *)(*(int *)(param_1 + 0xc) + 0x194) = 0;
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x154), 0, 2, 1, 0xc330000043b18000, 0x42f8000043b18000, 0, 0, 0, 0);
  *(u32 *)(*(int *)(param_1 + 0xc) + 0x194) = 0;
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x198), 0, 2, 1, 0x43c08000423c0000, 0x43c08000423c0000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x1dc), 0, 2, 1, 0x43c0800043c40000, 0x43c0800043c40000, 0, 0, 0, 0);
  return;
}
...

{
  ...
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc)), 0, 2, 2, uVar1, uVar1, 0, 0, 0, 0);
  uVar1 = CAMP_PAIR_FLOAT_HIGH((float)(*(int *)(param_1 + 4) * 0x21) + 124.0f,0x44138000);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x88), 0, 2, 2, uVar1, uVar1, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x44), 0, 2, 2, 0x42fa000043c50000, 0x42fa000043c50000, 0, 0, 0, 0);
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0xcc), 0, 2, 2, 0x42fc000043c90000, 0x42fc000043c90000, 0, 0, 0, 0);
  *(u32 *)(*(int *)(param_1 + 0xc) + 0x150) = 0;
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x110), 0, 2, 2, 0x4170000043a08000, 0x4419c00043a08000, 0, 0, 0, 0);
  *(u32 *)(*(int *)(param_1 + 0xc) + 0x194) = 0;
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x154), 0, 2, 2, 0x42f8000043b18000, 0x4435000043b18000, 0, 0, 0, 0);
  *(u32 *)(*(int *)(param_1 + 0xc) + 0x194) = 0;
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x198), 0, 2, 2, 0x43c08000423c0000, 0x43c08000423c0000, 0, 0, 0, 0);
  *(u32 *)(*(int *)(param_1 + 0xc) + 0x194) = 0;
  func_0018bc10(100.0f, (void*)(*(int *)(param_1 + 0xc) + 0x1dc), 0, 2, 2, 0x43c0800043c40000, 0x43c0800043c40000, 0, 0, 0, 0);
  return;
}
