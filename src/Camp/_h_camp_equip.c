...
typedef struct CampEquipWork
{
    u8 reserved00[0x12];
    s16 pcId;
    u8 reserved14[8];
    s16 selectedCategory;
    u8 reserved1E[0x292];
    void* equipmentAtlas;
    void* effectAtlas;
} CampEquipWork;
...
void FUN_0012e3b0(CampEquipWork* work, s32 index, u8* record)
{
    void* parent;
    s32 styles[4];
    char labels[4][0x100];
    ...
    for (i = 0; i < 4; i++) {
        ...
        id = (u16)datGetEquipmentId(work->pcId,
                                    equipment);
        effect = (u8)func_0016f810(work->pcId,
                                   equipment);
    ...
    case 0:
        {
            ...
            valueA = func_0016f9f0(
                work->pcId,
                datGetEquipmentIdx(work->pcId, 0)) & 0xffff;
            valueB = func_0016fae0(
                work->pcId,
                datGetEquipmentIdx(work->pcId, 0)) & 0xffff;
            if (work->selectedCategory == 0) {
                campEquipDrawSpriteCall(parent, work->equipmentAtlas,
                                        0x18, *(u8*)(record + 0x40),
                                        *(f32*)(record + 0x38),
                                        *(f32*)(record + 0x3c),
                                        *(f32*)(record + 0x24));
    ...
    case 1:
        {
            ...
            value = func_0016fbd0(
                work->pcId,
                datGetEquipmentIdx(work->pcId, 1)) & 0xffff;
            if (work->selectedCategory == 1) {
                campEquipDrawSpriteCall(parent, work->equipmentAtlas,
                                        0x18, *(u8*)(record + 0x40),
                                        *(f32*)(record + 0x38),
                                        *(f32*)(record + 0x3c),
    ...
    case 2:
        {
            ...
            value = func_0016fcc0(
                work->pcId,
                datGetEquipmentIdx(work->pcId, 2)) & 0xffff;
            if (work->selectedCategory == 2) {
                campEquipDrawSpriteCall(parent, work->equipmentAtlas,
                                        0x18, *(u8*)(record + 0x40),
                                        *(f32*)(record + 0x38),
                                        *(f32*)(record + 0x3c),
    ...
    case 4:
        {
            ...
            id = datGetEquipmentId(
                     work->pcId,
                     datGetEquipmentIdx(work->pcId,
                                        work->selectedCategory)) & 0xffff;
            color = func_0016f900(
                        work->pcId,
                        datGetEquipmentIdx(work->pcId,
                                           work->selectedCategory)) & 0xff;
    ...
    case 5:
        ...
        return;
    case 6:
        campEquipDrawSpriteCall(parent, work->effectAtlas,
                                0, *(u8*)(record + 0x40),
                                *(f32*)(record + 0x38),
                                *(f32*)(record + 0x3c),
                                *(f32*)(record + 0x24));
    ...
    case 1:
        ...
        case 1:
            campEquipDrawSpriteCall(
                ...
                (u8)*(u32*)(record + 0x40), 44.0f + *(f32*)(record + 0x38) - 40.0f,
                *(f32*)(record + 0x3c), *(f32*)(record + 0x24));
            break;
        case 2:
            campEquipDrawSpriteCall(
