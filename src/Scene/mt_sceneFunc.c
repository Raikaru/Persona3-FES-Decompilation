...
u32 FUN_003b88c0(u32 param_1,long param_2,u32 *param_3,long param_4);
...
u32 FUN_003bac40(long param_1,char param_2);
u64 FUN_003bb010(u64 param_1,u64 param_2);
void FUN_003bb060(u32 param_1,u8 param_2);
...
float FUN_003bc220(float param_1,float param_2,char *param_3,float *param_4,u64 param_5);
float FUN_003bc730(char *param_1,int param_2);
int FUN_003bc8f0(char *param_1);
u8 FUN_003bc900(u32 *param_1);
void FUN_003bc940(void);
void FUN_003bcbf0(long param_1,long param_2);
...

{
  ...
  if (param_2 == 0) {
    ...
    uVar1 = *(u32 *)(iVar7 + 0x28);

    *(u32 *)(iVar7 + 0x28) = uVar1 | 1;

    *(u32 *)(iVar7 + 0x28) = uVar1 & 0xffffffbf | 1;

    if (param_4 == 1) {

      *(u32 *)(iVar7 + 0x28) = *(u32 *)(iVar7 + 0x28) | 0x40;

    }

    *(u32 *)(iVar7 + 0x58) = param_1;
    ...
    *(u32 *)(iVar7 + 0x5c) = 0;
    ...
    if (*(int *)(iVar7 + 0x54) == 0) {
      ...
      lVar3 = (*DAT_00960178)(0x130,0x40000);

      *(int *)(iVar7 + 0x54) = (int)lVar3;
    ...
    uVar8 = FUN_003bc0e0(*(u32 *)(iVar7 + 0x54));

    *(u32 *)(iVar7 + 0x60) = uVar8;

    uVar4 = FUN_00530da0(uVar8);

    FUN_005225a8(0x6a2df0,uVar4);
...

{
  ...
  if (param_1 != 0) {
    ...
    *(u32 *)(iVar1 + 0x28) = *(u32 *)(iVar1 + 0x28) | 4;

    *(u32 *)(iVar1 + 100) = *(u32 *)(iVar1 + 0x10);

    *(u32 *)(iVar1 + 0x68) = *(u32 *)(iVar1 + 0x14);

    *(u32 *)(iVar1 + 0x6c) = *(u32 *)(iVar1 + 0x18);

    *(u32 *)(iVar1 + 0x70) = uStack_10;

    *(u32 *)(iVar1 + 0x74) = uStack_c;

    *(u32 *)(iVar1 + 0x78) = uStack_8;

    *(u8 *)(iVar1 + 0x7c) = 0;

    *(u8 *)(iVar1 + 0x7d) = param_4;

    *(u32 *)(iVar1 + 0x80) = param_3;
...
FUN_003b8ff0(u32 param_1,long param_2,u32 param_3,u64 param_4,u16 param_5,
...

{
  ...
  if (param_2 == 0) {
    ...
    lVar2 = FUN_003186e0(uVar1,param_3 & 0xffff,(short)param_4);

    if (lVar2 == 0) {

      FUN_003189f0(param_1,uVar1,param_3 & 0xffff);

      FUN_003182d0(uVar1,param_3 & 0xffff,(short)param_4,param_5,param_6 == 1);

      if (0 < param_7) {

        FUN_00318770((float)(int)param_7,uVar1,param_3 & 0xffff);

      }

      FUN_005225a8(0x6a2e10,uVar1,param_3,param_4);
...
FUN_003b91c0(u32 param_1,u64 param_2,u64 param_3,u64 param_4,
...

{
  ...
  if (lVar1 == 0) {
    ...
    uVar2 = FUN_003b8ff0(param_1,lVar1,param_3,param_4,param_5,param_6,param_7);
...
#define FUN_003b91c0(...) ((u64 (*)(...))FUN_003b91c0)(__VA_ARGS__)
#undef FUN_003b9260
// FUN_003B9260 NONMATCHING


u32

FUN_003b9260(u32 param_1,long param_2,u32 param_3,u32 param_4,
...

{
  ...
  if (param_2 == 0) {
    ...
    *(u32 *)(puVar3 + 2) = param_4;

    *(u32 *)(puVar3 + 4) = param_5;

    *(u32 *)(puVar3 + 6) = param_6;

    *(u32 *)(puVar3 + 8) = param_7;

    *(u32 *)(puVar3 + 10) = param_1;
...
#define FUN_003b9260(...) ((u32 (*)(...))FUN_003b9260)(__VA_ARGS__)
#undef FUN_003b9320
// FUN_003B9320 NONMATCHING


u64

FUN_003b9320(u32 param_1,u64 param_2,u64 param_3,u64 param_4,
...

{
  ...
  if (lVar1 == 0) {
    ...
    uVar2 = FUN_003b9260(param_1,lVar1,param_3,param_4,param_5,param_6,param_7);
...
void FUN_003b93c0(u32 param_1,u16 param_2,u16 param_3,short param_4,
...

{
  ...
  if (param_4 == -1) {
    ...
    if (lVar2 != 0) {
      ...
      FUN_003b8ff0(0x3f800000,lVar2,0,param_2,param_3,1,0);
    ...
    if (lVar2 != 0) {
      ...
      FUN_003b8ff0(0x3f800000,lVar2,0,param_2,param_3,0,0);
    ...
    if (lVar2 != 0) {
      ...
      FUN_003b9260(0x3f800000,lVar2,0,param_4,param_5,1,0);
  ...
  if (param_1 != 0) {
    ...
    if ((*(u32 *)(puVar8 + 0x14) & 1) != 0) {
      ...
      if (cVar9 == '\0') {
        ...
        FUN_003bc220(*(u32 *)(puVar8 + 0x2e),*(u32 *)(puVar8 + 0x30),

                     *(u32 *)(puVar8 + 0x2a),&uStack_58,&uStack_68);
...

{
  ...
  lVar1 = FUN_003b5d10(param_1 & 0x3ff | 0xc00);

  if (lVar1 != 0) {

    FUN_003bac40(lVar1,param_2);
...

{
  ...
  if (param_2 <= param_1) {
    ...
    for (iVar3 = 0; iVar3 < 4; iVar3 = iVar3 + 1) {
      ...
      auStack_d0[iVar3] = *(u32 *)(param_3 + iVar2 + 4);

      auStack_e0[iVar3] = *(u32 *)(param_3 + iVar2 + 8);

      auStack_f0[iVar3] = *(u32 *)(param_3 + iVar2 + 0xc);
    ...
    *param_4 = fStack_8;
    ...
    for (lVar4 = 0; lVar4 < *param_3; lVar4 = (long)((int)lVar4 + 1)) {
      ...
      for (iVar3 = 0; iVar3 < 4; iVar3 = iVar3 + 1) {
        ...
        auStack_d0[iVar3] = *(u32 *)(param_3 + iVar2 * 0xc + 4);

        auStack_e0[iVar3] = *(u32 *)(param_3 + iVar2 * 0xc + 8);

        auStack_f0[iVar3] = *(u32 *)(param_3 + iVar2 * 0xc + 0xc);
...

{
  ...
  bVar1 = DAT_007ce658 != 0;

  if (bVar1) {

    *param_1 = DAT_0095aff0;

    param_1[1] = DAT_0095aff4;
...

{
  ...
  if (param_2 == 0) {
    ...
    DAT_007ce664 = (short)param_2 * 10;

    DAT_007ce660 = (u16)(((u32)DAT_007ce664 << 2) / 10);

    FUN_003500a0((short)param_1,(short)param_2);
