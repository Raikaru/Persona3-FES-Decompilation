...
int FUN_003b1360(long param_1,char param_2);
...

{
  ...
  return *(u16 *)((&DAT_0095acf4)[(param_1 & 0xff) * 8] + 0x10);
...

{
  ...
  return *(u16 *)((&DAT_0095acf4)[(param_1 & 0xff) * 8] + 0x12);
...

{
  ...
  *(u32 *)(&DAT_0095ac70 + param_1 * 4) = param_2;
