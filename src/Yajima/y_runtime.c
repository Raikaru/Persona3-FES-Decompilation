    ...
    for (iVar15 = 1; (long)iVar15 < 4; iVar15 = iVar15 + 1) {
      if ((long)iVar15 != (long)cVar13) {
        ...
        if (((bVar12) && (cVar4 = FUN_004353f0((int)((u8 *)DAT_008717a0 + iVar15 * 0x1c0)), cVar4 == '\x06')) &&
           (iVar10 = FUN_001c7160(500.0f,(u8 *)DAT_008717a0 + cVar13 * 0x1c0,
                                  (u8 *)DAT_008717a0 + iVar15 * 0x1c0), iVar10 == 1)) {
          cVar13 = (char)iVar15;
          goto LAB_004381a4;
        }
      }
...

{
  ...
  iVar8 = (int)param_2;
  iVar6 = iVar8 * 6;
  fVar9 = (float)FUN_00421fe0(0,0,0xff,*(short *)(iVar6 + iGpffffb9fc + 0x7c),param_3);
  uVar10 = (u32)fVar9;
      ...
      *(u32 *)(iVar1 + 0x44) = uVar7;
      ...
      if (FUN_00454520((float *)auStack_60,*(u8 *)(iVar1 + 1)) == 0) {
        *(u8 *)(iVar1 + 3) = 4;
        ...
        FUN_001ad940(&v,*(u32 *)(DAT_008717f4 + 0x1e0));
        a[1] = v;
        a[0] = a[1];
        a[0].y = 400.0f;
        a[1].y = -400.0f;
  ...
  do {
    ...
    *(u16 *)(iVar1 + 0x92) = uVar11;
    ...
    case '\0':
      ...
      if (((lVar5 == 1) && (lVar5 = FUN_00454400((f32*)(&fStack_10),(char)(*(u8 *)(iVar1 + 1))), lVar5 == 1)
...

{
  ...
  if ((DAT_007ce6bc == '\x01') && (*(int *)((u8 *)DAT_0086ef2c + *(char *)(iVar1 + 1) * 0x1c0) == 2)) {
    ...
    FUN_001ad940(&target,*(u32 *)(((u8 *)DAT_008717f4)[*(char *)(iVar1 + 0x18) * 0x70] + 0x1e0)
                );
    FUN_001ad940(&self,
                 *(u32 *)(*(int *)((u8 *)DAT_0086edf4 + *(char *)(iVar1 + 1) * 0x1c0) + 0x1e0));
    first = self;
...

{
  ...
  if (fVar9 >= 300.0f) {
    ...
    FUN_001ad940(auStack_180,
                 *(u32 *)(*(int *)((u8 *)DAT_0086edf4 + *(char *)(iVar1 + 1) * 0x1c0) + 0x1e0));
    fStack_28 = fVar9 + fStack_178;
    collision.x = fStack_30;
    collision.y = fStack_2c;
    collision.z = fStack_28;
    line[1] = collision;
    line[0] = line[1];
    line[0].y = 400.0f;
    line[1].y = -400.0f;
  ...
  if (fVar9 >= *pfVar6) {
    ...
    collision2.x = fStack_30;
    collision2.y = fStack_2c;
    collision2.z = fStack_28;
    line2[1] = collision2;
    line2[0] = line2[1];
    line2[0].y = 400.0f;
    line2[1].y = -400.0f;
...

{
  ...
  do {
    if (3 < (long)iVar11) {
      ...
      if (sVar4 != -1) {
        iVar11 = cVar10 * 0x1c0;
        FUN_001ad940(&target,*(u32 *)(((u8 *)DAT_008717f4)[cVar10 * 0x70] + 0x1e0));
        uVar14 = 0xffffffffffffffff;
        FUN_00318ed0_typed(*(u32 *)(((u8 *)DAT_008717f4)[cVar10 * 0x70] + 0x128),2,(float *)(&origin));
    ...
    if (cVar2 == '\x01') {
      ...
      if ((lVar6 != 1) && (lVar6 = FUN_00195460(*(u32 *)(puVar3 + 0x10)), lVar6 == 0)) {
        if (puVar3[2] == '\x01') {
          ...
          FUN_001b0020_typed((u32)(*(u32 *)((u8 *)DAT_0086e810 + iVar7)),(void*)(&fStack_10),(s32)(*(u16 *)((u8 *)DAT_006b4ac6 + iVar8)));
        }
          ...
          if (cVar1 == '\x02') {
            ...
            if (lVar6 != 0) {
              if (puVar3[0x14] == '\x01') {
                ...
                lVar6 = FUN_001afa20_typed(((float)*(int *)((u8 *)DAT_007bc6b0 + (char)puVar3[6] * 4)),(void*)(*(u32 *)((u8 *)DAT_0086e810 + iVar7)),(void*)(&fStack_10));
                if (lVar6 != 0) {
  ...
  if (bVar9) {
    for (iVar12 = 0; iVar12 < 4; iVar12 = iVar12 + 1) {
      ...
      if (bVar9) {
        ...
        FUN_001ad940(auStack_10,*(u32 *)(*piVar13 + 0x1e0));
        iVar5 = FUN_0044f1c0(*(float *)((u8 *)DAT_006b4abc + iVar7),(float *)(iVar3 + 0x30),(float *)auStack_10);
        if (iVar5 == 1) {
          *(u8 *)(iVar1 + 7) = 1;
          if (iVar10 == 0) {
            cVar6 = 0xd;
          ...
          uVar4 = FUN_00459f60(param_1,*(u16 *)((u8 *)DAT_006b4ac0 + iVar7),cVar6);
        ...
        iVar3 = FUN_00318b60(*(u32 *)(*(int *)((u8 *)DAT_0086e6f4 + iVar8) + 0x128));
        FUN_001ad940(auStack_20,*(u32 *)(*piVar13 + 0x1e0));
        iVar5 = FUN_0044f1c0(*(float *)((u8 *)DAT_006b4ab4 + iVar7),(float *)(iVar3 + 0x30),(float *)auStack_20);
        if (iVar5 == 1) {
          iVar6 = FUN_00318b60(*(u32 *)(*(int *)((u8 *)DAT_0086e6f4 + iVar8) + 0x128));
          FUN_001ad940(auStack_30,*(u32 *)(*piVar13 + 0x1e0));
          iVar5 = FUN_001c6450_typed(iVar6,auStack_30,*(float *)((u8 *)DAT_006b4ab8 + iVar7),
                                     *(float *)((u8 *)DAT_006b4ab4 + iVar7));
          if (iVar5 == 1) {
            *(u8 *)(iVar1 + 7) = 1;
            if (iVar10 == 0) {
              cVar6 = 0xd;
