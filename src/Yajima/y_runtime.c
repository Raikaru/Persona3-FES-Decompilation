...
#pragma alias FUN_0016c970_s16 FUN_0016c970
extern u32 FUN_0016c970_s16(s16 param_1);
...

{
  ...
  if (param_1 == '\0') {
    ...
    iVar1 = *(s16 *)(DAT_00871948_abs + param_1 * 0x1c0);
  }
  uVar2 = FUN_0016c970_s16(iVar1);
  if ((uVar2 & 1) != 0) {
    cVar3 = cVar3 + 1;
  }
  uVar2 = FUN_0016c970_s16(iVar1);
