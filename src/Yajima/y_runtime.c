...
u32 FUN_00433de0(int param_1)
{
  ...
  if ((*(u8 *)(field + (u32)currentY * 0x100 + (u32)currentX * 0x10 + 0x53) & 2) != 0) {
    ...
    if ((node->x == 0) && (node->y == 0)) {
      ...
      work->openCount++;
      node = &work->nodes[(work->x - 1) + (u32)work->y * 16];
      if ((node->x == work->targetX) && (node->y == work->targetY)) {
        target = &work->nodes[targetIndex];
        target->x = work->targetX;
        target->y = work->targetY;
  ...
  if ((*(u8 *)(field + (u32)currentY * 0x100 + (u32)currentX * 0x10 + 0x53) & 4) != 0) {
    ...
    if ((node->x == 0) && (node->y == 0)) {
      ...
      work->openCount++;
      node = &work->nodes[(u32)work->x + (work->y + 1) * 16];
      if ((node->x == work->targetX) && (node->y == work->targetY)) {
        target = &work->nodes[targetIndex];
        target->x = work->targetX;
        target->y = work->targetY;
  ...
  case 0:
    ...
    if (lVar9 == 0) {
      ...
      if (lVar9 == 0) {
        ...
        uStack_10[0] = fStack_60;
        uStack_10[1] = fStack_5c;
        fStack_8 = fStack_58;
    ...
    if (lVar9 == 0) {
      *(u8 *)(iVar1 + 0x1218) = 4;
      ...
      if (lVar7 == 0) {
        ...
        uStack_20[0] = fStack_90 * 200.0f + fStack_80;
        uStack_20[1] = fStack_8c * 200.0f + fVar10;
    ...
    *(u16 *)(iVar1 + 0x92) = uVar11;
    ...
    case '\0':
      ...
      if (((lVar5 == 1) && (lVar5 = FUN_00454400((f32*)(&fStack_10),(char)(*(u8 *)(iVar1 + 1))), lVar5 == 1)
          ) && (lVar5 = FUN_00454d00(*(RwV3d *)&fStack_10), lVar5 == 1)) {
