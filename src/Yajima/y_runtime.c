...

{
  ...
  if (cVar1 == '\0') {
    FUN_001140d0_f3(4.0f,*(float *)(puVar2 + iVar8 * 8 + 0x2cc) - 128.0f,
                    *(float *)(puVar2 + iVar8 * 8 + 0x2d0) - 64.0f,
                    uVar10 | 0xffffff00,0x100,0x80,
                    *(u32 *)(puVar2 + iVar8 * 4 + 0x274));
    ...
    FUN_001140d0_f3(4.0f,*(float *)(puVar2 + iVar8 * 8 + 0x2cc) - 128.0f,
                    *(float *)(puVar2 + iVar8 * 8 + 0x2c8) - 64.0f,
                    uVar10 | 0xffffff00,0x100,0x80,
                    *(u32 *)(puVar2 + iVar8 * 4 + 0x3c4));
  }
  return bVar7;
}
