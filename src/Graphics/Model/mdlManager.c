    ...
    if (((lVar5 < (long)(u32)*(u16 *)(piVar1 + 1)) &&
      ...
      if ((*puVar4 & 1) == 0) {
        ...
        *(float *)(puVar4 + 6) = fGpffff80e4 * *(float *)(puVar4 + 4);
        ...
        func_004b74c0(*(u32 *)(puVar4 + 6),*(u32 *)(*(int *)(puVar4 + 0x10) + 0x20));

        func_004b7010(*(u32 *)(*(int *)(puVar4 + 0x10) + 0x20),0x313090,param_2);
...
u64 FUN_00315f50(u64 param_1,u32 *param_2)

{
  ...
  *(u32 *)(iVar1 + 8) = *(u32 *)(iVar1 + 8) | 0x40;
  ...
  for (uVar6 = 0; uVar6 < uVar2; uVar6 = uVar6 + 1) {
    ...
    uVar5 = FUN_001a6400(iVar4,0x69aba0);
...

{
  ...
  for (uVar1 = 0; uVar1 < 0x10; uVar1 = uVar1 + 1 & 0xffff) {
    ...
    if (*(short *)(iVar3 + 0x198) != 0) {
      ...
      for (uVar4 = 0; uVar4 < 4; uVar4 = uVar4 + 1 & 0xffff) {
        ...
        *(float *)(iVar2 + 300) = in_f5;

        *(u32 *)(iVar2 + 0x130) = *(u32 *)(param_2 + 0x18c);

        *(u32 *)(iVar2 + 0x134) = *(u32 *)(param_2 + 400);
    ...
    if (((*(u16 *)(iVar8 + 0xd8) & 2) == 0) && (*(char *)(iVar8 + 0xd3) != '\0')) {
      ...
      if (((*(u16 *)(iVar8 + 0xd8) & 0x20) == 0) || (*(char *)(iVar8 + 0xd3) == -1)) {
        ...
        if (iVar9 == 0) {
          ...
          RpSkyRenderStateSet(2, (void*)*(u32 *)(iVar8 + 0xe4));

          RpSkyRenderStateSet(3, (void*)*(u32 *)(iVar8 + 0xe8));

          func_001a88e0(*(u32 *)(iVar8 + 0xdc));

        }

        else if ((*(u16 *)(iVar8 + 0xd8) & 0x18) == 0x18) {

          func_001a7b50(iVar9,1);

          func_001a7fc0(iVar9,1);

          func_001a8140(iVar9,1);

        }

        else {

          func_001a7b50(iVar9,0);

          func_001a7fc0(iVar9,0);

          func_001a8140(iVar9,0);
      ...
      if (*(int *)(iVar8 + 0x3f4) != 0) {
        ...
        if ((*(u16 *)(iVar8 + 0xd8) & 0x8000) != 0) {
          ...
          func_004916d0(*(u32 *)(iVar8 + 0xdc),0x316360,&iStack_8);
        ...
        if (iVar9 != 0) {
          ...
          *(u32 *)(iVar9 + 0x10) = uVar13;
          ...
          if (*(int *)(iVar9 + 0x18) != 0) {
            ...
            func_0031dd40(*(int *)(iVar9 + 0x18),iVar9 + 4);

            func_0031dc80(*(u32 *)(iVar9 + 0x18),uVar4);

          }

          if (*(int *)(iVar9 + 0x24) != 0) {

            func_0031e240(*(int *)(iVar9 + 0x24),iVar9 + 4);

            func_0031e1e0(*(u32 *)(iVar9 + 0x24));
      ...
      for (uVar10 = 0; uVar10 < 5; uVar10 = uVar10 + 1 & 0xffff) {
        ...
        if ((((*(u8 *)(iVar9 + 0x3b4) & 1) != 0) &&
           ...
           (lVar7 = mdl00319770((Model*)param_1,uVar10), lVar7 != 0)) {

          iStack_c = 1;

          func_004916d0(*(u32 *)(*piVar11 + 0xdc),0x316360,&iStack_c);

          if (iStack_c == 0) {

            mdlSetColor((Model*)*piVar11,(const RwRGBA*)(iVar8 + 0xd0));
...

{
  ...
  if (lVar6 == 1) {
    ...
    if ((iStack_4 == 0) || (iStack_8 == 0)) {
      ...
      func_0031b820(param_1,*(u16 *)((int)param_1 + 0xd6));
    ...
    sVar3 = *(short *)(iVar8 + 0xd6);

    psVar10 = (short*)&DAT_0069b190;
...
LAB_0031bfb8:
    ...
    if (bVar4) {
      ...
      func_0031b820(param_1,iStack_4);
