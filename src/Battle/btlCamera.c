...
void func_002aa2b0(BtlCamera* camera, int param_2, int param_3)
{
  ...
  FUN_004be1e0_b6070((RwV3d*)&fStack_10,(const RwV3d*)0x697870,1,(const void*)(iVar2 + 0x1c));
  fStack_3c = fStack_4 * 0.5f;
  fStack_20 = fStack_30 - fStack_40;
  fStack_1c = fStack_2c - fStack_3c;
  fStack_18 = fStack_28 - fStack_38;
  fVar14 = (float)FUN_004c69f0_b6070((RwV3d*)&fStack_20,(RwV3d*)&fStack_20);
  ...
  if ((lVar8 != 0) || (((bVar4 && (lVar6 = FUN_002a3380((u8*)camera), lVar6 != 0)) && (lVar7 == 0)))) {
    ...
    *(undefined2 *)(iVar9 + 0x124) = 0;
    ...
    fStack_7c = fVar15;
    fVar11 = (float)FUN_004c69f0_b6070((RwV3d*)&fStack_10,(RwV3d*)&fStack_10);
    ...
    FUN_002a4690_b6070((void*)auStack_110,(const void*)&fStack_b4,(const void*)&fStack_60,(const void*)&D_00697880);
    btlUnitGetSphereWorldCenter((BtlUnit*)(uintptr_t)(iVar2), (RwV3d*)&fStack_30);
    ...
    fVar15 = (float)FUN_004c69f0_b6070((RwV3d*)&fStack_10,(RwV3d*)&fStack_10);
    fVar13 = (float)FUN_0052e930(fVar17);
    fVar15 = fVar15 + fVar14 / fVar13;
    FUN_004be1e0_b6070((RwV3d*)&fStack_10,(const RwV3d*)0x6978a0,1,(const void*)&uStack_c4);
    ...
    FUN_002a4690_b6070((void*)auStack_110,(const void*)&fStack_d0,(const void*)&fStack_60,(const void*)&D_00697880);
    uVar16 = uGpffff8074;
  }
  else {
    ...
    *(undefined2 *)(iVar9 + 0x124) = 1;
    ...
    if (lVar7 == 0) {
      ...
      fStack_1c = fStack_2c - fStack_3c;
      fStack_18 = fStack_28 - fStack_38;
      fVar15 = (float)FUN_004c69f0_b6070((RwV3d*)&fStack_20,(RwV3d*)&fStack_20);
      fVar15 = fVar15 * 0.25f;
...
void func_002ab330(BtlCamera* camera, int param_2, int param_3)
{
  ...
  *(undefined4 *)(iVar6 + 0x100) = *(undefined4 *)(*(int *)(iVar6 + 0xe0) + 0x38);
  ...
  fStack_b8 = *(float *)(iVar6 + 0x9c) - pos[0];
  fStack_b4 = *(float *)(iVar6 + 0xa4) - pos[2];
  ...
  if (targeting) {
    ...
    *(undefined2 *)(iVar6 + 0x124) = 0;
    ...
    fStack_c0 = dir[2];
    fStack_bc = -dir[0];
    fVar16 = dir[2] * fStack_b8 + fStack_bc * fStack_b4;
    if (0.0f <= fVar16) {
    ...
    FUN_002a4690(&uStack_d8, dir, pos, &D_00697880);
    FUN_004be1e0(dir,0x6978a0,1,&uStack_d8);
    fStack_b0 = pos[0];
    fStack_ac = pos[2];
    fStack_a8 = cam[0];
    fStack_a4 = cam[2];
    ...
    if (fVar12 <= fVar13) {
      if (pos[1] < fVar13) {
        ...
        cam[1] = *(float *)(iVar2 + 0x8c) * *(float *)(iVar2 + 0x2c) * 0.25f + fStack_3c + 0.0f;
      }
    }
    else {
      cam[1] = fVar13 * 0.25f + fStack_3c + 0.0f;
    }
    cam[2] = fStack_8c;
    ...
    if (fVar16 < 0.0f) {
      ...
      fStack_94 = dir[2];
      FUN_004c6b20(&fStack_98,&fStack_98);
      cam[0] = fStack_94 * fVar10 + cam[0] + 0.0f;
      cam[2] = (cam[2] + 0.0f) - fStack_98 * fVar10;
    }
    fStack_e4 = cam[0] + dir[0];
    fStack_e0 = cam[1] + dir[1];
    fStack_dc = cam[2] + dir[2];
    if (fStack_e0 < 25.0f) {
      fStack_e0 = 25.0f;
    }
    ...
    cam[1] = fVar15 * 0.5f + fStack_3c + 0.0f;
    if (0.0f <= fVar16) {
      cam[0] = dir[2] * fVar10 + fStack_40 + 0.0f;
      cam[2] = (fStack_38 + 0.0f) - dir[0] * fVar10;
    }
    else {
      cam[0] = (fStack_40 + 0.0f) - dir[2] * fVar10;
      cam[2] = dir[0] * fVar10 + fStack_38 + 0.0f;
      fVar13 = fVar13 * 0.5f;
    ...
    FUN_002a4690(&uStack_f4, dir, pos, &D_00697880);
    FUN_004be1e0(dir,0x6978a0,1,&uStack_f4);
    fStack_b0 = pos[0];
    fStack_ac = pos[2];
    fStack_a8 = cam[0];
    fStack_a4 = cam[2];
    ...
    cam[0] = fStack_90;
    cam[1] = fVar15 * 0.25f + fStack_3c + 0.0f;
    cam[2] = fStack_8c;
    fVar13 = (float)FUN_0052e930(fGpffff8070 * *(float *)(iVar6 + 0xb8) * 0.5f);
    ...
    fStack_100 = cam[0] + dir[0];
    fStack_fc = cam[1] + dir[1];
    fStack_f8 = cam[2] + dir[2];
    if (fStack_fc < 25.0f) {
      fStack_fc = 25.0f;
    }
    uVar11 = 0x40200000;
    ...
    *(undefined2 *)(iVar6 + 0x124) = 1;
    ...
    fStack_c0 = dir[2];
    fStack_bc = -dir[0];
    fVar14 = dir[2] * fStack_b8 + fStack_bc * fStack_b4;
    cam[1] = fStack_3c;
    if (0.0f <= fVar14) {
    ...
    if (0.0f <= fVar14) {
      ...
      fStack_94 = fStack_78;
      FUN_004c6b20(&fStack_98,&fStack_98);
      cam[0] = (cam[0] + 0.0f) - fStack_94 * fVar10;
      cam[2] = fStack_98 * fVar10 + cam[2] + 0.0f;
    }
    fStack_100 = cam[0] + dir[0];
    fStack_fc = cam[1] + dir[1];
    fStack_f8 = cam[2] + dir[2];
    ...
    uStack_d0 = uStack_ec;
    uStack_cc = uStack_e8;
    dir[0] = sphere0[0] - fStack_100;
    dir[1] = sphere0[1] - fStack_fc;
    dir[2] = sphere0[2] - fStack_f8;
    ...
    dir[1] = dir[1] * fVar10;
    dir[2] = dir[2] * fVar10;
    fStack_100 = fStack_e4 + dir[0];
    fStack_fc = fStack_e0 + dir[1];
    fStack_f8 = fStack_dc + dir[2];
    if (fStack_fc < 25.0f) {
      fStack_fc = 25.0f;
    }
    if (fStack_e0 < 25.0f) {
