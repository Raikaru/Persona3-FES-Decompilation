...
extern BtlPacket* FUN_002a3d70_packet_voice(f32, u32, u32, u32, u32, u32);
...

{
  ...
  *(u32 *)(iGpffffb6fc + 0xc) = *(u32 *)(iGpffffb6fc + 0xc) | 0x80000;
  ...
  for (uVar12 = 0; uVar12 < uVar11; uVar12 = uVar12 + 1 & 0xffff) {
    ...
    uVar8 = FUN_00284200(1.0f,*(u32 *)(iVar4 + 0x30),0x12,0,2);
...
void func_002f2550(BtlAction* action)
{
  ...
  packet = FUN_002a3d70_packet_voice(uGpffff82e0_f32_voice,
                                     *(u32*)(DAT_007ce3ec + 0x148),
                                     0x69a250, 0x69a270, 0x69a290, 0x69a2b0);
  packet->preUpdateDelay = 3;
  packet->actionUID = action->uid;
  btlPacketRegister(packet, 0);
...
void func_002f2890(BtlAction* param_1)
{
  ...
  packet->actionUID = action->uid;
  btlPacketRegister(packet, 0);
  index = (FUN_002ffbc0(100) < 0x32) ? 0 : 0xc;
  packet = FUN_002a3d70_packet_voice(uGpffff82dc_f32_voice,
                                     *(u32*)(DAT_007ce3ec + 0x148),
                                     index + 0x69a2d0, index + 0x69a2f0,
                                     index + 0x69a310, index + 0x69a330);
  packet->preUpdateDelay = 3;
  packet->actionUID = action->uid;
  btlPacketRegister(packet, 0);
...
LAB_002e59dc:
  ...
  FUN_004c6b20(&fStack_d8,&fStack_d8);
  fStack_b0 = dir.z;
  fStack_ac = -dir.x;
...

{
  ...
  if (*(char *)(iVar5 + 0xa2) == '\0') {
    ...
    fStack_30 = fStack_10;
    fStack_28 = fStack_8;
    fVar8 = *(float *)(iVar5 + 0x90) * *(float *)(iVar5 + 0x2c) * 1.25f;
    ...
    fStack_30 = fStack_20;
    fStack_28 = fStack_18;
    fVar8 = *(float *)(iVar1 + 0x90) * *(float *)(iVar1 + 0x2c) * 0.5f;
  ...
  fStack_b0 = fStack_58;
  fStack_ac = -fStack_60;
  if (0.0f <= fStack_58 * fStack_a8 + fStack_ac * fStack_a4) {
    fStack_70 = fStack_58 * fVar8 + fStack_30 + 0.0f;
    fStack_68 = (fStack_28 + 0.0f) - fStack_60 * fVar8;
  }
  else {
    fStack_70 = (fStack_30 + 0.0f) - fStack_58 * fVar8;
    fStack_68 = fStack_60 * fVar8 + fStack_28 + 0.0f;
  }
  fVar8 = fStack_28;
  FUN_004be1e0(&fStack_60,0x6978a0,1,auStack_c8);
  fVar8 = FUN_002d1fd0(&fStack_a0,&fStack_98,&fStack_78,&fStack_80);
  fStack_9c = fStack_38;
  fStack_98 = fStack_70;
  fStack_94 = fStack_68;
  fStack_78 = fStack_30;
  fVar7 = FUN_0052e930(DAT_007cad60 * *(float *)(iVar2 + 0xb8) * 0.5f);
  fVar8 = fVar6 * *(float *)(iVar4 + 0x90) * *(float *)(iVar4 + 0x2c) + fVar8 + 0.0f;
  fStack_70 = fStack_80;
  fStack_68 = fStack_7c;
  fStack_6c = fVar7;
  fVar6 = 100.0f;
  if (100.0f <= fVar8 / fVar7) {
    fVar6 = fVar8 / fVar7;
  }
  ...
  fVar6 = FUN_002d1f30(auStack_e4,auStack_c8);
  FUN_002a4470(&fStack_70,(f32*)(iVar2 + 0x9c));
  fVar6 = FUN_002d1f30(&fStack_7c,&fStack_98);
  if (DAT_007cadc4 < fVar6) {
    FUN_002a44f0(&fStack_70,&fStack_8c);
    uVar3 = 3;
  }
  else {
    uVar3 = 0x33;
  }
  FUN_002a3e80(50.0f,(u8*)*(int*)(iVar2 + 0xe0),(u8*)(iVar4 + 4),(u8*)&fStack_8c,uVar3);
  FUN_002a44f0(&fStack_70,&fStack_8c);
  FUN_004be1e0(&fStack_100,0x6978a0,1,&fStack_7c);
  fStack_100 = fStack_100 * 150.0f;
  fStack_104 = fStack_104 * 150.0f;
  fStack_108 = fStack_108 * 150.0f;
  fStack_8c = fStack_70 + fStack_100;
  fStack_90 = fStack_74 + fStack_104;
  fStack_94_b = fStack_78 + fStack_108;
  if (fStack_90 < 22.5f) {
    fStack_90 = 22.5f;
  }
  if (weight == 0.0f) {
    FUN_002a2290(camera,&fStack_70,&fStack_8c,1);
    FUN_002a3110(camera,2.0f);
  }
  else {
    FUN_002a2290(camera,&fStack_70,&fStack_8c,1);
    FUN_002a3110(camera,weight);
  }
  return;
}
...

{
  ...
  *(u64 *)(puVar9 + 0x60) = *unaff_s2_lo;
  FUN_0027ed20(uVar11,0);
  uVar11 = FUN_00284200(1.0f,aiStack_8[0],0x18,0,0);
  puVar9 = (u8 *)uVar11;
  *puVar9 = 4;
  *(u64 *)(puVar9 + 8) = *(u64 *)(puVar8 + 0x58);
  *(u64 *)(puVar9 + 0x60) = *unaff_s2_lo;
  FUN_0027ed20(uVar11,1);
  uVar11 = FUN_00284200(1.0f,iVar3,0x18,0,0);
  puVar9 = (u8 *)uVar11;
  *puVar9 = 4;
  *(u64 *)(puVar9 + 8) = *(u64 *)(puVar8 + 0x58);
  *(u64 *)(puVar9 + 0x60) = *unaff_s2_lo;
...

{
  ...
  *(u64 *)(puVar10 + 0x60) = *unaff_s4_lo;
  ...
  uVar13 = FUN_00284200(1.0f,aiStack_8[0],0x17,0,0);
  puVar10 = (u8 *)uVar13;
  *puVar10 = 4;
  *(u64 *)(puVar10 + 8) = *(u64 *)(puVar8 + 0x58);
  *(u64 *)(puVar10 + 0x60) = *unaff_s4_lo;
  FUN_0027ed20(uVar13,1);
  uVar13 = FUN_00284200(1.0f,iVar4,0x17,0,0);
  puVar10 = (u8 *)uVar13;
  *puVar10 = 4;
  *(u64 *)(puVar10 + 8) = *(u64 *)(puVar8 + 0x58);
  *(u64 *)(puVar10 + 0x60) = *unaff_s4_lo;
  ...
  *(u64 *)(puVar10 + 0x60) = *unaff_s4_lo;
  FUN_0027ed20(uVar13,1);
  uVar13 = FUN_00284200(1.0f,aiStack_8[0],0x19,8,1);
  puVar11 = (u8 *)uVar13;
  *puVar11 = 4;
  ...
  *(u64 *)(puVar10 + 0x60) = *unaff_s4_lo;
  FUN_0027ed20(uVar13,1);
  uVar13 = FUN_00284200(1.0f,iVar4,0x19,8,1);
  puVar11 = (u8 *)uVar13;
  *puVar11 = 4;
  *(u64 *)(puVar11 + 8) = *(u64 *)(puVar10 + 0x58);
  *(u64 *)(puVar11 + 0x60) = *unaff_s4_lo;
...

{
  ...
  *(short *)(iVar3 + 0xa0) = *(short *)(iVar3 + 0xa0) + 1;
  ...
  uVar5 = FUN_00284200(1.0f,iVar3,0x12,0,2);
  iVar1 = (int)uVar5;
  *(u16 *)(iVar1 + 0x48) = 2;
  ...
  *(u64 *)((int)uVar5 + 0x60) = *param_1;
  ...
  if (iVar6 != 0) {
    ...
    *(u64 *)(puVar2 + 0x60) = *param_1;
    FUN_0027ed20(uVar5,1);
    uVar5 = FUN_00284200(1.0f,iVar6,0,0,1);
    puVar2 = (u8 *)uVar5;
    *puVar2 = 5;
    *(u64 *)(puVar2 + 8) = *(u64 *)(iVar3 + 0x58);
    *(u16 *)(puVar2 + 0x48) = 8;
...

{
  ...
  *(u64 *)((int)uVar12 + 0x60) = uVar14;
  ...
  uVar12 = FUN_00284200(1.0f,*(u32 *)(param_1 + 6),7,6,2);
  iVar6 = (int)uVar12;
