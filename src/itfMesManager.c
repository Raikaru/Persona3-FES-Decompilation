...
void FUN_003a3b00(long param_1);
...
void FUN_003a5210(int param_1,u64 param_2,u8 param_3,u8 param_4,  u16 param_5);
...
u32 FUN_003a5940(int param_1,long param_2);
...
void FUN_003a6060(long param_1,u64 param_2);
...
void FUN_003a6334(int param_1,int param_2,int param_3);
void FUN_003a6360(int param_1,u32 param_2);
...
#define FUN_003a6334(...) ((void (*)(...))FUN_003a6334)(__VA_ARGS__)
#define FUN_003a6360(...) ((void (*)(...))FUN_003a6360)(__VA_ARGS__)
    ...
    if ((*(u32*)mes & 0x3300) == 0)
    {
            ...
            *(u32*)(window + 0x28) != param_3)
        {
            *(s16*)&mes->unkData[0x12] = type;
            ...
            FUN_003a6ca0(&mes->unkData[0xa8], type, param_3);
            if (*(u32*)(window + 4) != 0)
            {
...

{
  ...
  if (lVar3 < 0) {
    ...
    iVar1 = *(int *)(&DAT_00959eec + (int)lVar3 * 0x34);
...

{
  ...
  if (lVar4 < 0) {
    ...
    puVar2 = *(u32 **)(&DAT_00959eec + (int)lVar4 * 0x34);
...

{
  ...
  iVar1 = *(int *)(&DAT_00959eec + param_1 * 0x34);
...

{
  ...
  return *(u16 *)(iVar1 + 0x54);

}
#define FUN_003a2750(...) ((u16 (*)(...))FUN_003a2750)(__VA_ARGS__)
#undef FUN_003a27c0
// FUN_003A27C0 NONMATCHING
...

{
  ...
  return *(u16 *)(iVar1 + 0x56);

}
#define FUN_003a2830(...) ((u16 (*)(...))FUN_003a2830)(__VA_ARGS__)
#undef FUN_003a28a0
// FUN_003A28A0 NONMATCHING
...

{
  ...
  if (lVar3 < 0) {
    ...
    puVar1 = *(u32 **)(&DAT_00959eec + (int)lVar3 * 0x34);
...

{
  ...
  puVar1 = *(u32 **)(&DAT_00959eec + (int)param_1 * 0x34);
...

{
  ...
  puVar2 = *(u32 **)(&DAT_00959eec + (int)param_1 * 0x34);
...

{
  ...
  if (-1 < param_1) {
    ...
    FUN_003a3470(*(u32 *)(&DAT_00959eec + (int)param_1 * 0x34));
...

{
  ...
  FUN_003a6930(param_1 + 9,0);

  uVar1 = *param_1;

  *param_1 = uVar1 & 0xfffffff8;

  *param_1 = uVar1 & 0xfffdfff8;
...

{
  ...
  puVar2 = *(u32 **)(&DAT_00959eec + param_1 * 0x34);
...

{
  ...
  FUN_003a3b00(*(u32 *)(&DAT_00959eec + param_1 * 0x34));
...

{
  ...
  return *(u32 *)(param_2 * 4 + iVar1 + 0xd4);
...

{
  ...
  FUN_003a5ca0(*(u32 *)(&DAT_00959eec + param_1 * 0x34),param_2,param_3,0);
...

{
  ...
  FUN_003a5ea0(*(u32 *)(&DAT_00959eec + param_1 * 0x34));
...

{
  ...
  if (param_2 == 7) {
    ...
    piVar2 = (int *)(&DAT_00959eec + iVar3 * 0x34);
...

{
  ...
  iVar2 = *(int *)(&DAT_00959eec + param_1 * 0x34);
...

{
  ...
  if (*(char *)(param_1 + 0x1c) == '\0') {
    ...
    FUN_0035ac90(param_1 + 0x20,param_1 + 0x20,param_1 + *(int *)(param_1 + 0x10),
...

{
  ...
  uVar1 = *(u32 *)(*(int *)(&DAT_00959eec + param_1 * 0x34) + 0x30);

  FUN_003b0bb0(uVar1,param_4);

  FUN_003b0c20(uVar1,param_5);

  FUN_003b0ce0(uVar1,param_2);

  thunk_FUN_003b0e04(uVar1,param_3);
...

{
  ...
  FUN_003a5fd0(*(int *)(&DAT_00959eec + (int)param_7 * 0x34) + 0xd4);
...

{
  ...
  iVar1 = *(int *)(&DAT_00959eec + param_7 * 0x34);
...

{
  ...
  FUN_003a5fd0(*(int *)(&DAT_00959eec + (int)param_8 * 0x34) + 0xd4);
...

{
  ...
  iVar1 = *(int *)(&DAT_00959eec + (int)param_8 * 0x34);
...

{
  ...
  if ((param_2 < 0) || (*(short *)(param_1 + 0x18) <= param_2)) {
    ...
    uVar1 = *(u32 *)((int)param_2 * 4 + param_1 + 0x1c);
...

{
  ...
  return *(u32 *)
          ...
          (*(int *)(*(int *)(*(int *)(param_1 + 4) + 0x18) * 8 + *(int *)(param_1 + 4) + 0x20) +

          (u32)*(u16 *)(param_1 + 0x20) * 4);

}
#define FUN_003a6030(...) ((u32 (*)(...))FUN_003a6030)(__VA_ARGS__)
#undef FUN_003a6060
// FUN_003A6060 NONMATCHING
...

{
  ...
  uVar1 = FUN_003b2940(*(u32 *)(iVar2 + 0x14),*(u32 *)(iVar2 + 0x18),0,1,0,0xff,

                       param_2,0);

  *(u32 *)(iVar2 + 0x1c) = uVar1;

  *(u16 *)(iVar2 + 0x20) = 0xffff;
...

{
  ...
  while( 1 ) {
    ...
    if (*(short *)(param_1 + 0x26) <= lVar2) {

      return 0xffff;

    }

    iVar1 = param_1 + (int)lVar2 * 4;

    if (((u32)DAT_007e094e & 1 << ((int)*(short *)(iVar1 + 0x28) & 0x1fU)) != 0) break;

    lVar2 = (long)((int)lVar2 + 1);

  }

  return *(u16 *)(iVar1 + 0x2a);
...

{
  ...
  for (iVar2 = DAT_00959ed0; iVar2 != 0; iVar2 = *(int *)(iVar2 + 4)) {
...

{
  ...
  for (iVar1 = DAT_00959ed0; iVar1 != 0; iVar1 = *(int *)(iVar1 + 4)) {

    FUN_003a7e90(*(u32 *)(iVar1 + 0xc));

  }

  DAT_00959ec8 = DAT_00959ec8 + 1;
...

{
  ...
  FUN_003ab2a0(*(u32 *)(*(int *)(&DAT_00959eec + param_1 * 0x34) + 0xac));
