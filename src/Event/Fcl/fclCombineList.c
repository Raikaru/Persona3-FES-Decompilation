...

{
  ...
  *(int *)(iVar1 + 0x80) = (int)uVar2;
  uVar2 = kwlnTaskCreate((KwlnTask *)uVar2,(const char *)0x6a6ad8,0x18b6,FUN_003e0870,0,0);
  kwlnTaskCreate((KwlnTask *)uVar2,(const char *)0x6a6ae8,0x106f,FUN_003e08e0,0,0);
  return;
}
