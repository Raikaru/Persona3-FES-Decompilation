...

{
  ...
  if (param_3 != 0) {
    ...
    FUN_0040e3c0_f32(0,param_1,param_2,param_3,0x59,(u32)bVar1 * -2);

    FUN_0040e3c0_f32(0,param_1,param_2,param_3,0x5a,(u32)bVar1 * -2);
...
LAB_00401fa8:
    ...
    if (found) {
      ...
      if (*(char *)((u32)*(u16 *)(param_3 + 2) * 0xe + iGpffffb730 + 2) == '\x01') {
