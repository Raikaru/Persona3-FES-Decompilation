...

{
  ...
  lVar3 = (*DAT_00960178)(0x60,0x40000);
  ...
  memcpy((void*)(iVar5 + 0x1c),(const void*)param_1,0x18);


  *(u32 *)(iVar5 + 0x3c) = uVar1;

  iVar2 = kwlnGetMainCamera();

  *(u32 *)(iVar5 + 0x38) = *(u32 *)(iVar2 + 4);

  uVar1 = FUN_003c44d0(0,0,0,0);

  *(u32 *)(iVar5 + 0x40) = uVar1;

  uVar4 = kwlnTaskCreate(0,0x6b2ae8,10,0x417410,0x417680,lVar3);

  uVar1 = kwlnTaskCreate(uVar4,0x6b2af8,0x18a6,0x417540,0,lVar3);

  *(u32 *)(iVar5 + 8) = uVar1;

  uVar1 = kwlnTaskCreate(uVar4,0x6b2b10,0x83d,0x417590,0,lVar3);

  *(u32 *)(iVar5 + 0xc) = uVar1;

  uVar1 = kwlnTaskCreate(uVar4,0x6b2b20,0x106f,0x4175e0,0,lVar3);

  *(u32 *)(iVar5 + 0x10) = uVar1;

  uVar1 = kwlnTaskCreate(uVar4,0x6b2b40,0x147a,0x417630,0,lVar3);

  *(u32 *)(iVar5 + 0x14) = uVar1;

  uVar1 = FUN_003cda60(uVar4,0);

  *(u32 *)(iVar5 + 0x18) = uVar1;

  *(u32 *)(iVar5 + 4) = *(u32 *)(iVar5 + 4) | 2;
...

{
  ...
  if ((*(u32 *)(iVar3 + 0x18) & 4) != 0) {
    ...
    fStack_20 = (-(fStack_10 - 320.0) * *(float *)(iVar4 + 0x68)) / 320.0;

    fStack_1c = (-(fStack_c - 224.0) * *(float *)(iVar4 + 0x6c)) / 224.0;
...

{
  ...
  uStack_10 = DAT_006b2ed8;

  fStack_8 = DAT_006b2ee0;

  piVar1 = (int *)*param_2;

  uStack_20 = DAT_006b2ee8;

  uStack_18 = DAT_006b2ef0;
...

{
  ...
  uStack_8 = DAT_006b2f20;

  uStack_20 = DAT_006b2f28;

  uStack_18 = DAT_006b2f30;

  for (iVar3 = 0; iVar3 < *(int *)(iVar1 + 4); iVar3 = iVar3 + 1) {

    iVar2 = *(int *)(*(int *)(iVar1 + iVar3 * 4 + 8) + 8);

    FUN_004bdde0(0x420c0000,iVar2 + 0x10,&uStack_10,0);

    FUN_004bdde0(0x43340000,iVar2 + 0x10,&uStack_20,1);
...

{
  ...
  uStack_10 = DAT_006b2fb8;

  uStack_8 = DAT_006b2fc0;
...

{
  ...
  uStack_10 = DAT_006b2ff8;

  uStack_8 = DAT_006b3000;

  uStack_20 = DAT_006b3008;

  fStack_18 = DAT_006b3010;
...

{
  ...
  if (*(int *)(param_2 + 0x10) == 0) {
    ...
    *(int *)(*(int *)(param_1 + 0x3c) + 8) = *(int *)(*(int *)(param_1 + 0x3c) + 8) + -1;
