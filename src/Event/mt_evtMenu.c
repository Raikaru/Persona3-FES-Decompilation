...

{
  ...
  case 0:
    ...
    if (iVar1 < 2) {
      uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
      evtMenuDrawText((param_1 + 0x10) * 0xc, param_2 * 0xc, uVar3, uVar2, (const char *)&gp0xffffa068, ((u32 *)auStack_8)[iVar1]);
    }
    break;
  case 1:
    uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
  ...
  case 2:
    uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
    evtMenuDrawText(param_1 * 0xc, param_2 * 0xc, uVar3, 0, (const char *)(void *)0x69fdc8);
    if (*(int *)(param_4 + 0x198) == 0) {
      uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
      evtMenuDrawText((param_1 + 0x10) * 0xc, param_2 * 0xc, uVar3, uVar2, (const char *)&gp0xffffa3b8, *(u32 *)(param_4 + 0x1a0));
    }
    else {
      uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
      evtMenuDrawText((param_1 + 0x10) * 0xc, param_2 * 0xc, uVar3, uVar2, (const char *)&gp0xffffa640);
    }
    break;
  case 3:
    uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
    evtMenuDrawText(param_1 * 0xc, param_2 * 0xc, uVar3, 0, (const char *)(void *)0x69fdd8);
    if (*(int *)(param_4 + 0x198) == 0) {
      uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
      evtMenuDrawText((param_1 + 0x10) * 0xc, param_2 * 0xc, uVar3, uVar2, (const char *)&gp0xffffa3b8, *(u32 *)(param_4 + 0x1a4));
    }
    else {
      uVar3 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));
      evtMenuDrawText((param_1 + 0x10) * 0xc, param_2 * 0xc, uVar3, uVar2, (const char *)&gp0xffffa640);
...

{
  ...
  case 0:
    ...
    if (*(int *)(iVar2 + 0x1b8) == 0) {
      uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
      evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar3, uVar1, (const char *)&gp0xffffa0b8);
    }
    else {
      uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
      evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar3, uVar1, (const char *)&gp0xffffa0c0);
    }
    break;
  case 1:
    uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
    ...
    uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
    evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar3, uVar1, (const char *)&gp0xffffa3b8, *(u32 *)(iVar2 + 0x1bc));
    break;
  case 2:
    uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
    evtMenuDrawText(param_1 * 0xc, param_2 * 0xc, uVar3, 0, (const char *)(void *)(DAT_006a0000_abs + 0x210));
    uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
    evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar3, uVar1, (const char *)&gp0xffffa3b8, *(u32 *)(iVar2 + 0x1c0));
    break;
  case 3:
    uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
    evtMenuDrawText(param_1 * 0xc, param_2 * 0xc, uVar3, 0, (const char *)(void *)(DAT_006a0000_abs + 0x220));
    uVar3 = FUN_0038a220(*(u32 *)(iVar2 + 0xe0));
    evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar3, uVar1, (const char *)&gp0xffffa3b8, *(u32 *)(iVar2 + 0x1c4));
    break;
  }
...

{
  ...
  case 0:
    ...
    if (iVar1 < 2) {
      uVar4 = FUN_0038a220(*(u32 *)(iVar3 + 0xe0));
      evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar4, uVar2, (const char *)&gp0xffffa068, (u32)apuStack_8[iVar1]);
    }
    break;
  case 1:
    uVar4 = FUN_0038a220(*(u32 *)(iVar3 + 0xe0));
    evtMenuDrawText(param_1 * 0xc, param_2 * 0xc, uVar4, 0, (const char *)&gp0xffffa6e8);
    uVar4 = FUN_0038a220(*(u32 *)(iVar3 + 0xe0));
    evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar4, uVar2, (const char *)&gp0xffffa3b8, *(u32 *)(iVar3 + 0x19c));
    break;
  case 2:
    uVar4 = FUN_0038a220(*(u32 *)(iVar3 + 0xe0));
    evtMenuDrawText(param_1 * 0xc, param_2 * 0xc, uVar4, 0, (const char *)(void *)(DAT_006a0000_abs + 0x250));
    uVar4 = FUN_0038a220(*(u32 *)(iVar3 + 0xe0));
    evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar4, uVar2, (const char *)&gp0xffffa3b8, *(u32 *)(iVar3 + 0x1a0));
    break;
  case 3:
    uVar4 = FUN_0038a220(*(u32 *)(iVar3 + 0xe0));
    evtMenuDrawText(param_1 * 0xc, param_2 * 0xc, uVar4, 0, (const char *)(void *)(DAT_006a0000_abs + 0x260));
    uVar4 = FUN_0038a220(*(u32 *)(iVar3 + 0xe0));
    evtMenuDrawText((param_1 + 0x14) * 0xc, param_2 * 0xc, uVar4, uVar2, (const char *)&gp0xffffa3b8, *(u32 *)(iVar3 + 0x1a4));
    break;
  }
