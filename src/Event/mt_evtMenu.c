...

{
  ...
  if (0x32 < param_1) {
    ...
    FUN_0019d3f0(0x69e408,0xa0);

  }

  iVar2 = (int)param_1 * 0xc;

  pcVar3 = DAT_0069e1aa + iVar2;
  ...
  if (*pcVar3 != '\x01') {
    ...
    if (*pcVar3 == '\x02') {
      ...
      for (lVar4 = 0; lVar4 < *(short *)(DAT_0069e1a0 + iVar2); lVar4 = (long)((int)lVar4 + 1)) {

        if (*(char *)((int)(DAT_0069e1a0 + iVar2) + (int)lVar4 + 2) == '\x12') {
...

{
  ...
  *(short *)(iVar1 * 8 + param_4 + 0x90) = (short)(param_1 & 0xff);

  *(u16 *)(*(int *)(param_4 + 0xd0) * 8 + param_4 + 0x92) = param_2;

  *(u16 *)(*(int *)(param_4 + 0xd0) * 8 + param_4 + 0x94) = param_3;
...

{
  ...
  if (*(int *)(param_1 + 0xd0) == 0) {
    ...
    *(int *)(param_1 + 0xd0) = iVar2;
    ...
    sVar1 = *(short *)(iVar2 * 8 + param_1 + 0x90);
...
void FUN_0036f680(long param_1,long param_2,int param_3,int param_4,u64 param_5,
...

{
  ...
  if ((param_2 != 0) && (1 < param_3)) {
    ...
    if ((DAT_007e094e & param_7) == 0) {

      if ((DAT_007e0952 & param_7) != 0) {
    ...
    if ((DAT_007e094e & param_6) == 0) {

      if ((DAT_007e0952 & param_6) != 0) {
...
void FUN_0036f900(u64 param_1,int param_2,int param_3,int param_4,int param_5,

                 u64 param_6,u64 param_7,long param_8,code *param_9)
...

{
  ...
  return (&DAT_0069e422)[*(int *)(param_1 + 0x268) + **(int **)(param_1 + 0x164) * 0xc];
...

{
  ...
  if ((param_3 != 1) && (param_3 == 0)) {
    ...
    for (lVar8 = 0; lVar8 < *(short *)(&DAT_0069e420 + *piVar3 * 0xc);
      ...
      FUN_0038a260(uVar10,iVar5,param_2 * 0xc,0xe,(&PTR_s_OFFSET_0069e6a0)[cVar1]);
      ...
      if (cVar1 == '\x03') {
        ...
        FUN_0038a260(uVar10,iVar5,iVar6,uVar7,0x7ccd50,
        ...
        if (*(char *)(*(int *)(param_4 + 0x164) + 0x22) == '\0') {
          ...
          FUN_0038a260(uVar10,iVar5,iVar6,uVar7,0x7ccd68);
          ...
          FUN_0038a260(uVar10,iVar5,iVar6,uVar7,0x7ccd70);
        ...
        if (cVar2 < '\x03') {
          ...
          FUN_0038a260(uVar10,iVar5,iVar6,uVar7,0x7ccd58,(&PTR_s_DISABLE_0069e6c8)[cVar2]);
          ...
          FUN_0038a260(uVar10,iVar5,iVar6,uVar7,0x7ccd60,*(u16 *)(iVar4 + 0x24));
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69e6f0);
...

{
  ...
  FUN_0036f900(param_1,param_2,0x14,0xf,*(u32 *)(iVar2 + 0x108),iVar1 + 3,param_3,0,0);
...

{
  ...
  FUN_0038a260(uVar2,param_1 * 0xc,param_2 * 0xc,0,0x69e888,uVar1);
...

{
  ...
  ppuVar4 = &PTR_s_L_FLAG_NOTUSE_0069e990;
  ...
  if (param_3 < 9) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x0037185c. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007ba6f0[param_3]();
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69eaa0);
...

{
  ...
  FUN_0038a260(uVar12,0x78,0x78,0,&gp0xffffa130);

  uVar12 = FUN_0038a220(*(u32 *)(iVar7 + 0xe0));

  FUN_0038a260(uVar12,0x78,0x78,uVar10,&gp0xffffa060,*(u16 *)(iVar3 + 0x14));
  ...
  FUN_0038a260(uVar12,0x78,0x84,0,&gp0xffffa134);

  uVar12 = FUN_0038a220(*(u32 *)(iVar7 + 0xe0));

  FUN_0038a260(uVar12,0x78,0x84,uVar10,&gp0xffffa060,*(u16 *)(iVar3 + 0x16));
  ...
  FUN_0038a260(uVar12,0x78,0xb4,0,&gp0xffffa138);

  uVar12 = FUN_0038a220(*(u32 *)(iVar7 + 0xe0));

  FUN_0038a260(uVar12,0x78,0xb4,uVar10,&gp0xffffa060,*(u8 *)(iVar3 + 0x1b));
  ...
  FUN_0038a260(uVar12,0x78,0xc0,0,&gp0xffffa140);
  ...
  if (cVar6 == '\x02') {
    ...
    FUN_0038a260(uVar12,0x78,0xc0,uVar10,0x69eb88);
    ...
    FUN_0038a260(uVar12,0x78,0xc0,uVar10,0x69eb78);
    ...
    FUN_0038a260(uVar12,0x78,0xc0,uVar10,0x69eb68);
  ...
  FUN_0038a260(uVar12,0x78,0xcc,0,&gp0xffffa148);

  uVar12 = FUN_0038a220(*(u32 *)(iVar7 + 0xe0));

  uVar4 = FUN_00530da0(*(u32 *)(iVar3 + 0x1c));

  FUN_0038a260(uVar12,0x78,0xcc,uVar10,0x69eb98,uVar4);
  ...
  FUN_0038a260(uVar12,0x78,0xd8,0,&gp0xffffa150);

  uVar12 = FUN_0038a220(*(u32 *)(iVar7 + 0xe0));

  uVar4 = FUN_00530da0(*(u32 *)(iVar3 + 0x20));

  FUN_0038a260(uVar12,0x78,0xd8,uVar10,0x69eb98,uVar4);
...

{
  ...
  case 4:
    ...
    puVar8 = (u32 *)FUN_001a42f0(*(u32 *)(iVar12 + 0xe8),0);
    ...
    *(u32 *)(iVar12 + 0x19c) = *puVar8;
    ...
    puVar8 = (u32 *)FUN_001a42f0(*(u32 *)(iVar12 + 0xe8),2);

    *(u32 *)(iVar12 + 0x1a0) = *puVar8;

    puVar8 = (u32 *)FUN_001a42f0(*(u32 *)(iVar12 + 0xe8),3);

    *(u32 *)(iVar12 + 0x1a4) = *puVar8;

    puVar8 = (u32 *)FUN_001a42f0(*(u32 *)(iVar12 + 0xe8),4);

    *(u32 *)(iVar12 + 0x1a8) = *puVar8;

    puVar8 = (u32 *)FUN_001a42f0(*(u32 *)(iVar12 + 0xe8),5);

    *(u32 *)(iVar12 + 0x1ac) = *puVar8;

    piVar4 = (int *)FUN_001a41b0(*(u32 *)(iVar12 + 0xe8),6);

    *(float *)(iVar12 + 0x1b0) = (float)*piVar4;

    piVar4 = (int *)FUN_001a41b0(*(u32 *)(iVar12 + 0xe8),7);

    *(float *)(iVar12 + 0x1b4) = (float)*piVar4;
    ...
    FUN_003957d0(0x41200000,param_3,auStack_120);
  ...
  case 8:
    ...
    *pfStack_8 = fStack_98;
    ...
    FUN_003957d0(0x42c80000,param_3,auStack_180);
  ...
  case 0xc:
    ...
    *pfStack_8 = fStack_b8;
    ...
    FUN_003957d0(0x42c80000,param_3,auStack_1c0);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69ec38);
...

{
  ...
  if (param_3 < 6) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00375404. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007ba810[(int)param_3]();
...

{
  ...
  if (param_3 < 6) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00375790. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007ba830[(int)param_3]();
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69ecb8);
...

{
  ...
  if (param_3 < 10) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00375af0. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007ba850[(int)param_3]();
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69f990);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69f9c0);
  ...
  if (lVar4 == 0) {
    ...
    if (*(int *)(iVar5 + 0xd4) == 0x19) {
      ...
      *(int *)(iVar5 + 0x198) = (int)fStack_1c;
      ...
      FUN_003957d0(0x43160000,param_3,auStack_60);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fa70);
...

{
  ...
  DAT_009585b8 = *param_2;

  DAT_009585bc = param_2[1];

  DAT_009585c0 = param_2[2];

  DAT_009585a8 = *param_3;

  DAT_009585ac = param_3[1];

  DAT_009585b0 = param_3[2];
...

{
  ...
  uVar4 = (u32)(((u8 *)&DAT_00958700)[1]);

  if (uVar4 < 8) {

    if (uVar4 == 0) {

      afStack_60[0] = DAT_009585b8;

      afStack_70[0] = DAT_009585bc;

      afStack_80[0] = DAT_009585c0;

      FUN_003b79a0(auStack_c0,0x9585b8,0x9585a8);
      ...
      DAT_00958704 = DAT_009585b8;

      DAT_00958708 = DAT_009585bc;
      ...
      DAT_00958714 = DAT_009585bc + DAT_007cb120 * fStack_2c;

      DAT_00958718 = DAT_009585c0 + DAT_007cb120 * fStack_28;

      DAT_0095871c = DAT_009585b8 + DAT_007cb124 * fStack_30;

      DAT_00958720 = DAT_009585bc + DAT_007cb124 * fStack_2c;

      DAT_00958724 = DAT_009585c0 + DAT_007cb124 * fStack_28;

      DAT_00958728 = DAT_009585b8 + fStack_30;

      DAT_0095872c = DAT_009585bc + fStack_2c;

      DAT_00958730 = DAT_009585c0 + fStack_28;
      ...
      for (iVar5 = 0; iVar5 < 4; iVar5 = iVar5 + 1) {
        ...
        afStack_60[iVar5] = (float)(&DAT_00958700)[iVar9 * 3 + iVar5 * 3 + 1];

        afStack_70[iVar5] = (float)(&DAT_00958700)[iVar9 * 3 + iVar5 * 3 + 2];

        afStack_80[iVar5] = (float)(&DAT_00958700)[iVar9 * 3 + iVar5 * 3 + 3];
      ...
      pfVar8 = (float *)&DAT_00958728 + iVar9 * 3;

      *(float *)(&DAT_00958734 + iVar5) = *pfVar8 + DAT_007cb120 * fStack_40;

      pfVar7 = (float *)&DAT_0095872c + iVar9 * 3;

      *(float *)(&DAT_00958738 + iVar5) = *pfVar7 + fVar11;

      pfVar6 = (float *)&DAT_00958730 + iVar9 * 3;

      *(float *)(&DAT_0095873c + iVar5) = *pfVar6 + fVar10;

      fVar11 = DAT_007cb124 * fStack_3c;

      fVar10 = DAT_007cb124 * fStack_38;

      *(float *)(&DAT_00958740 + iVar5) = *pfVar8 + DAT_007cb124 * fStack_40;

      *(float *)(&DAT_00958744 + iVar5) = *pfVar7 + fVar11;

      *(float *)(&DAT_00958748 + iVar5) = *pfVar6 + fVar10;

      *(float *)(&DAT_0095874c + iVar5) = *pfVar8 + fStack_40;

      *(float *)(&DAT_00958750 + iVar5) = *pfVar7 + fStack_3c;

      *(float *)(&DAT_00958754 + iVar5) = *pfVar6 + fStack_38;
...

{
  ...
  if (param_3 == 0) {
    ...
    FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fb70,(((u8 *)&DAT_00958700)[1]));
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fb88);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fc20);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fc50);
...

{
  ...
  if (param_3 < 8) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x0037f6a4. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007baa30[param_3]();
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fcf0);
...

{
  ...
  if (param_3 < 6) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x003803d4. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007baa70[param_3]();
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fdf0);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fe30);
...

{
  ...
  uStack_8 = uGpffffa650;

  uStack_4 = uGpffffa654;

  ppuVar5 = &PTR_s_GAKURYOKU_0069feb0;
  ...
  if (param_3 < 7) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x003815dc. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007baaf0[param_3]();
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69ff10);
...

{
  ...
  if (param_3 < 8) {
                    ...
                    /* WARNING: Could not recover jumptable at 0x00381cb4. Too many branches */

                    /* WARNING: Treating indirect jump as call */

    PTR_LAB_007bab30[param_3]();
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69ff60);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69ffc0);
...

{
  ...
  if (param_3 == 0) {
    ...
    FUN_0038a260(uVar2,param_1 * 0xc,param_2 * 0xc,0,0x69ffe0);
    ...
    if (*(int *)(iVar2 + 400) == 0) {
      ...
      if ((DAT_007e0952 & 0x2000) == 0) {
        ...
        if ((DAT_007e0952 & 0x8000) != 0) {
          ...
          puVar1 = (u32 *)FUN_003b55b0(*(u32 *)(iVar2 + 0x198));
          ...
          *(u32 *)(iVar2 + 0x84c) = *puVar1;

          *(u32 *)(iVar2 + 0x850) = uVar5;

          *(u32 *)(iVar2 + 0x854) = uVar3;

          *(u32 *)(iVar2 + 0x858) = uVar4;
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69fff8);
...

{
  ...
  if (param_3 == 0) {
    ...
    FUN_0038a260(uVar2,param_1 * 0xc,param_2 * 0xc,0,0x6a0010);

    uVar2 = FUN_0038a220(*(u32 *)(param_4 + 0xe0));

    FUN_0038a260(uVar2,(param_1 + 0x19) * 0xc,param_2 * 0xc,uVar1,&gp0xffffa3b8,
...

{
  ...
  FUN_0036f900(param_1,param_2,0x23,0xb,0,1,param_3,0x383810,0);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x69f8b0);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x6a01a0);
...

{
  ...
  apuStack_10[0] = PTR_s_KAIKIN_006a01c0;

  apuStack_10[1] = PTR_DAT_006a01c4;

  apuStack_10[2] = PTR_s_REVERSE_006a01c8;

  apuStack_10[3] = PTR_s_HAMETU_006a01cc;
...

{
  ...
  FUN_0036f900(param_1,param_2,0x1e,6,0,1,param_3,0x3844b0,0);

  iVar2 = (int)param_3;

  if (*(int *)(iVar2 + 0xd4) == 0x2d) {
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x6a01e0);
...

{
  ...
  FUN_0038a260(uVar1,param_1 * 0xc,param_2 * 0xc,0,0x6a0230);
...
// FUN_00385860 NONMATCHING


u64

FUN_00385860(int param_1,u32 param_2,u64 param_3,u64 param_4,u64 param_5
...

{
  ...
  if (*(int *)(&DAT_006a0270 + param_1 * 4) == 0) {
    ...
    *(int *)((int)param_5 + 0xd8) = param_1;

    *(u32 *)((int)param_5 + 0xe0) = param_2;

    uVar1 = (**(code **)(&DAT_006a0270 + param_1 * 4))(param_3,param_4,param_5);
...

{
  ...
  *(u8 *)(param_1 + 0x940) = 0;
  ...
  for (iVar2 = 0; iVar2 < 7; iVar2 = iVar2 + 1) {
    ...
    if (*(int *)(param_1 + iVar2 * 4 + 0x944) != 0) {

      puVar1 = (u32 *)FUN_00100570();
...

{
  ...
  *param_1 = (u32)(uintptr_t)&DAT_009588a0;

  *param_2 = (u32)(uintptr_t)&DAT_00958890;
...

{
  ...
  *param_1 = (u32)(uintptr_t)&DAT_00958850;
...

{
  ...
  for (iVar2 = 0;
      ...
      (iVar3 = -1, iVar2 < 2 && (iVar1 = FUN_001a4510(DAT_007ce600), iVar3 = iVar2, iVar2 != iVar1))
...

{
  ...
  uVar2 = FUN_001a3ae0(*(u32 *)(param_2 + 0x92c),0xbe,0x100);

  FUN_001a3dc0(uVar2,0x6a0990,2);

  FUN_001a3bf0(uVar2,1);

  *(u32 *)(param_2 + 0x16c) = 0x10;
