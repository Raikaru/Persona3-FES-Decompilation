...
void FUN_0039e700(int param_1);
void FUN_0039e7c0(void);
void FUN_0039e820(u64 param_1);
u32 FUN_0039e880(int param_1,u64 param_2,u32 param_3,int param_4,u64 param_5);
void FUN_0039ea20(long param_1,u32 param_2);
...

{
  ...
  case 0:
    ...
    FUN_003b91c0(0x3f800000,uVar1,0,3,0,0,0);
...

{
  ...
  case 4:
    ...
    if ((int)puVar3[0x224] < (int)puVar3[0x225]) {
      ...
      FUN_003b91c0(0x3f800000,*(u16 *)(puVar3 + 1),0,0x16,0,0,0);

      FUN_003b9320(0x3f800000,*(u16 *)(puVar3 + 1),0,0x17,0,1,0);
  ...
  case 7:
    ...
    if (lVar10 == 1) {
      ...
      *puVar3 = 3;
      ...
      FUN_003b91c0(0x3f800000,*(u16 *)(puVar3 + 1),0,0x18,0,0,0);

      FUN_003b9320(0x3f800000,*(u16 *)(puVar3 + 1),0,0,0,1,0);
...

{
  ...
  uVar1 = (*DAT_00960178)(0x8dc,0x40000);

  FUN_00521408(uVar1,0,0x8dc);

  *(u16 *)((int)uVar1 + 4) = param_2;

  FUN_00194b20(param_1,0x6a1430,0x10,0x39a8a0,0x39b830,uVar1);
...

{
  ...
  if (0 < *(int *)(param_1 + 0x18)) {
    ...
    uStack_1 = (u8)*(int *)(param_1 + 0x18);

    uStack_4 = (undefined3)DAT_007cd488;

    uStack_10 = 0x42fe0000;
    ...
    uStack_18 = 0x41200000;

    uStack_14 = 0x41e80000;

    uStack_20 = 0x3ef40000;

    uStack_1c = 0x3edc0000;

    uStack_28 = 0x3f040000;

    uStack_24 = 0x3f280000;

    FUN_00388000(0x40a00000,0,&uStack_10,&uStack_18,&uStack_20,&uStack_28,

                 *(u32 *)(param_1 + 0x14),&uStack_4,0);

    uStack_10 = 0x43090000;

    uStack_18 = 0x43b78000;

    uStack_14 = 0x41e80000;

    uStack_20 = 0x3f030000;
    ...
    uStack_10 = 0x43fc0000;

    uStack_18 = 0x41200000;

    uStack_14 = 0x41e80000;

    uStack_20 = 0x3f0a0000;

    uStack_1c = 0x3edc0000;

    uStack_28 = 0x3f140000;
    ...
    uStack_10 = 0x43570000;

    uStack_c = 0x43380000;

    uStack_18 = 0x43580000;

    uStack_14 = 0x41d00000;

    uStack_20 = 0x3b800000;

    uStack_1c = 0x3c000000;

    uStack_28 = 0x3f550000;

    uStack_24 = 0x3e580000;

    FUN_00388000(0x40800000,0,&uStack_10,&uStack_18,&uStack_20,&uStack_28,
    ...
    uStack_10 = 0x43380000;

    uStack_c = 0x43560000;

    uStack_18 = 0x431f0000;
...

{
  ...
  if (iVar4 == 4) {
    ...
    if (iVar4 == 3) {
      ...
      uVar2 = FUN_0016df30((short)piVar1[3]);

      uVar7 = FUN_0030bbb0(uVar2);

      FUN_0039ef30(piVar8,0,uVar7);

      uVar7 = FUN_00173220((short)piVar1[0xd]);

      FUN_0039ef30(piVar8,1,uVar7);

      FUN_0039f210(piVar8,0,0xffffffffffffffff,0xffffffffffffffff);
      ...
      *piVar1 = 3;
      ...
      if (lVar6 == 1) {
        ...
        uVar7 = FUN_001021c0(0x6a15c0,auStack_4);
...

{
  ...
  if (iVar3 == 4) {
    ...
    if (iVar3 == 3) {
      ...
      FUN_0039f210(piVar7,0,0xffffffffffffffff,0xffffffffffffffff);
      ...
      *piVar1 = 3;
      ...
      if (lVar5 == 1) {
        ...
        uVar6 = FUN_001021c0(0x6a1600,auStack_4);
...

{
  ...
  case 1:
    ...
    if (lVar8 == 1) {
      ...
      uVar7 = FUN_001021c0(0x6a1640,auStack_4);

      FUN_0039ec70(puVar10,uVar7);

      uVar7 = FUN_001021c0(0x6a1400,auStack_4);
...

{
  ...
  if ((((long)param_2 < 3) && (-1 < (long)param_2)) && (param_1 != 0)) {

    bVar2 = 0;

    iVar1 = (int)param_2 * 0xc + (int)param_1;
    ...
    if (bVar2) {
      ...
      FUN_003196f0((int)param_1,param_2 & 0xffff);
