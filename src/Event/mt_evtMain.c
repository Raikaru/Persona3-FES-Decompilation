...

{
  ...
  if ((lVar1 == 1) && (lVar1 = FUN_003b5d10(0x1e59), lVar1 != 0)) {
    ...
    if (DAT_007e095f < 0x3c) {
      ...
      *(float *)(iVar2 + 4) = fStack_10 * 13.0f + *(float *)(iVar2 + 4);

      *(float *)(iVar2 + 8) = fStack_c * 13.0f + *(float *)(iVar2 + 8);

      *(float *)(iVar2 + 0xc) = fStack_8 * 13.0f + *(float *)(iVar2 + 0xc);

    }

    else if (0xbb < DAT_007e095f) {

      *(float *)(iVar2 + 4) = (*(float *)(iVar2 + 4)) - fStack_10 * 13.0f;

      *(float *)(iVar2 + 8) = (*(float *)(iVar2 + 8)) - fStack_c * 13.0f;

      *(float *)(iVar2 + 0xc) = (*(float *)(iVar2 + 0xc)) - fStack_8 * 13.0f;
...

{
  ...
  struct {
    u64 xy;
    u32 z;
  } stack60, stack50, stack30, stack20;
  float fStack_40;
  ...
  stack20.xy = DAT_0069d5f8;

  stack20.z = DAT_0069d600;

  stack30.xy = DAT_0069d608;

  stack30.z = DAT_0069d610;

  stack50.xy = DAT_0069d618;

  stack50.z = DAT_0069d620;

  stack60.xy = DAT_0069d628;

  stack60.z = DAT_0069d630;
  ...
  if ((lVar4 == 1) && (lVar4 = FUN_003b5d10(0x1e59), lVar4 != 0)) {
    ...
    FUN_004c6c60_evt_main(&fStack_10,&stack20,matrix);

    FUN_004c6c60_evt_main(&fStack_40,&stack30,matrix);
    ...
    if ((DAT_007e094c & 0x10) == 0) {
      ...
      if (DAT_007e095f < 0x3c) {
        ...
        *(float *)(iVar7 + 4) = fStack_10 * 10.0f + *(float *)(iVar7 + 4);

        *(float *)(iVar7 + 8) = fStack_c * 10.0f + *(float *)(iVar7 + 8);

        *(float *)(iVar7 + 0xc) = fStack_8 * 10.0f + *(float *)(iVar7 + 0xc);

      }

      else if (0xbb < DAT_007e095f) {

        *(float *)(iVar7 + 4) = (*(float *)(iVar7 + 4)) - fStack_10 * 10.0f;

        *(float *)(iVar7 + 8) = (*(float *)(iVar7 + 8)) - fStack_c * 10.0f;

        *(float *)(iVar7 + 0xc) = (*(float *)(iVar7 + 0xc)) - fStack_8 * 10.0f;

      }

      if (DAT_007e095e < 0x3c) {

        *(float *)(iVar7 + 4) = fStack_40 * 10.0f + *(float *)(iVar7 + 4);

        *(float *)(iVar7 + 8) = fStack_3c * 10.0f + *(float *)(iVar7 + 8);

        *(float *)(iVar7 + 0xc) = fStack_38 * 10.0f + *(float *)(iVar7 + 0xc);

      }

      else if (0xbb < DAT_007e095e) {

        *(float *)(iVar7 + 4) = (*(float *)(iVar7 + 4)) - fStack_40 * 10.0f;

        *(float *)(iVar7 + 8) = (*(float *)(iVar7 + 8)) - fStack_3c * 10.0f;

        *(float *)(iVar7 + 0xc) = (*(float *)(iVar7 + 0xc)) - fStack_38 * 10.0f;
...

{
  ...
  if ((puVar5 != (u16 *)0x0) && (*puVar5 == param_1)) {
    ...
    stack[1] = *(u32 *)(puVar5 + 10);

    stack[2] = 0;

    FUN_003b8b30(*(u16 *)(param_2 + 0xc),stack,puVar5[0x12],0);
...

{
  ...
  if ((puVar5 != (u16 *)0x0) && (*puVar5 == param_1)) {
    ...
    stack[0] = *(u32 *)(puVar5 + 0xc);

    stack[1] = stack[0];

    stack[2] = stack[0];

    FUN_003b8c30(*(u16 *)(param_2 + 0xc),stack,puVar5[10]);
...

{
  ...
  if (((puVar4 != (u16 *)0x0) && (*puVar4 == param_1)) &&
    ...
    if ((char)puVar4[9] == '\x01') {
      ...
      stack10[0] = *(u32 *)(puVar4 + 0xc);

      stack10[1] = *(u32 *)(puVar4 + 0xe);

      stack10[2] = *(u32 *)(puVar4 + 0x10);

      stack20[0] = *(u32 *)(puVar4 + 0x12);

      stack20[1] = *(u32 *)(puVar4 + 0x14);

      stack20[2] = 0;

      FUN_003b87f0(*(u16 *)(param_2 + 0xc),stack10,puVar4[1],(char)puVar4[0x18]);

      FUN_003b8b30(*(u16 *)(param_2 + 0xc),stack20,puVar4[1],(char)puVar4[0x18]);
    ...
    for (uVar7 = 0; (int)uVar7 < 4; uVar7 = uVar7 + 1) {
      ...
      if ((lVar3 != 0) && (lVar3 = ((code *)FUN_00366540)((u64)param_4,(int)param_3,(long)param_1,(long)uVar7), lVar3 != 0)) {
        ...
        if (*puVar5 == param_1) {
          ...
          FUN_003b8ff0_evt(fVar9,param_2,uVar7,unaff_s8,uStack_20,!bVar1,iVar4);
          ...
          if (*(char *)((int)puVar5 + 0x23) == '\x01') {
            ...
            FUN_003b9260_evt(fVar9,(u32)param_2,uVar6,(u32)lVar3,puVar5[0x13],
