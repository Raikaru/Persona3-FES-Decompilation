                                   ...
                                   void* callbackData, void* key)
{
    ...
    allocator = (u8*)D_00960184;
    context = (HCdvdStreamContext*)(*(void* (**)(u32, u32, u32))allocator)(1, 0x5c, 0x40000);
    ...
    slots = (HCdvdStreamSlot*)(*(void* (**)(u32, u32, u32))allocator)(count, 0x110, 0x40000);
    context->slots = slots;
    for (i = 0; i < count; i++)
    {
        slot = &slots[i];
