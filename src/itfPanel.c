...
u64 FUN_003a9170(int param_1);
u64 FUN_003a92a0(int param_1);
u64 FUN_003a92d0(int param_1);
...
void FUN_003ab2a0(long param_1,u32 param_2);
...
u64 FUN_003ac5a0(u64 param_1,u64 param_2);
...
u64 FUN_003adb00(u64 param_1,u64 param_2);
...
u64 FUN_003a9170(int param_1)
{
  ...
  *piVar1 = 1;
  iVar2 = piVar1[2] + 1;
  piVar1[2] = iVar2;
  piVar1[1] = 100 - iVar2 * 100 / 6;
  piVar1[3] = iVar2 < 2 ? 0 : iVar2 * 255 / 6;
  if (piVar1[2] >= 6) {
    *piVar1 = 2;
    piVar1[2] = 0;
    piVar1[1] = 0;
...
u64 FUN_003a92d0(int param_1)
{
  ...
  *piVar1 = 1;
  ...
  piVar1[2] = iVar2;
  if (iVar2 < 4) {
    piVar1[1] = 100 - iVar2 * 100 / 4;
    piVar1[3] = iVar2 * 255 / 10;
  } else {
    piVar1[1] = 0;
    piVar1[3] = 0xff;
  }
...

{
  ...
  *(u32 *)(param_1 + 0x140) = param_2;

  *(u32 *)(param_1 + 0x144) = param_3;

  *(u32 *)(param_1 + 0x148) = param_4;

  *(u32 *)(param_1 + 0x14c) = 1;

  *(u32 *)(param_1 + 0x150) = param_2;

  *(u32 *)(param_1 + 0x154) = param_3;

  *(u32 *)(param_1 + 0x158) = param_4;

  *(u32 *)(param_1 + 0x15c) = param_5;

  FUN_003b4a90(param_1 + 0x160);
...

{
  ...
  *(u32 *)(param_1 + 0x2c) = param_5;
  ...
  FUN_003b4a90(param_1 + 0x30);

  FUN_003b4a90(param_1 + 0x40,param_2,param_3,param_4,0x80,0x6a1eb0,2);
...

{
  ...
  for (iVar2 = 0; iVar2 < 3; iVar2 = iVar2 + 1) {
    ...
    aiStack_60[iVar2 * 8] = *piVar1 + iVar2 * 0x10;
  ...
  FUN_003b4b40(piVar1,piVar1 + 8,&gp0xffffa7d8,&gp0xffffa7dc,*(u32 *)(param_1 + 0xc),param_2)

  ;

  for (iVar2 = 0; iVar2 < 3; iVar2 = iVar2 + 1) {

    FUN_003b4ec0(aiStack_60,piVar1 + 8,iVar2 * 5 + 0x6a1fb0,iVar2 * 5 + 0x6a1fc0,5,
...

{
  ...
  *(u32 *)(iVar1 + 0x2c) = *(u32 *)(param_1 + 0x38);

  FUN_003b4b40(iVar1,iVar1 + 0x20,&gp0xffffa7e0,&gp0xffffb934,*(u32 *)(param_1 + 0xc),param_2
...

{
  ...
  if (param_1 == 0) {
    ...
    FUN_0019d3f0(0x6a1bf8,0x80b);

  }

  if (*(char *)((int)param_1 + 0x3c) != '\f') {

    FUN_0019d3f0(0x6a1bf8,0x80c);
...
u64 FUN_003ac5a0(u64 param_1,u64 param_2)
{
  ...
  pbVar1 = (u8 *)(*(int *)((int)param_2 + 0x10) + *(int *)((int)param_2 + 0x18));
  bVar2 = pbVar1[0] - 1;
  bVar3 = pbVar1[1];
  if (bVar3 == 0xff) {
    bVar3 = 0;
...

{
  ...
  if (lVar1 == 0) {
    ...
    FUN_00523ac8(&uStack_10,0x7cd520,uVar2);

    FUN_003b22a0(param_2);

    FUN_003b2020(&uStack_10,param_2);
...

{
  ...
  FUN_003ad400(uVar2 << 8 | *pbVar3 - 1 & 0xff,2,param_1,param_2);
...

{
  ...
  pbVar6 = (u8 *)(*(int *)(param_2 + 0x10) + *(int *)(param_2 + 0x18));
  ...
  FUN_003cf160(uVar2 << 8 | *(u8 *)(iVar3 + 4) - 1 & 0xff |
               ...
               (uVar4 << 8 | *(u8 *)(iVar8 + 2) - 1 & 0xff) << 8,uVar9 | 0x200);
