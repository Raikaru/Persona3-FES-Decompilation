...

{
  ...
  if (bVar2 == 0xff) {
    ...
    uVar6 = (u32)(u8)(bVar2 - 1);

  }


  uVar6 = (u8)uVar6 << 8 | (u8)firstLow;
  first2 = *(volatile int *)(param_2 + 0x18);
  second2 = *(volatile int *)(param_2 + 0x10);
  ...
  FUN_0016f1f0(uVar5 + aiStack_20[uVar6],1);
...

{
  ...
  FUN_0016f1f0(uVar5 + aiStack_20[uVar6],0);
  return 0;
